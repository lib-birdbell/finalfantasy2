...
;9859
.byte $A9,$40,$85,$64,$A9,$01,$85
.byte $65,$A9,$00,$85,$63,$4C,$C6,$9A
...
L31953:
	...
	TAY			; 99B7	$A8
	LDA $8D03,Y		; 99B8	$B9 $03 $8D
	STA $5C			; 99BB	$85 $5C
	LDA $8D13,X		; 99BD	$BD $13 $8D
	STA $5D			; 99C0	$85 $5D
	LDY #$04		; 99C2	$A0 $04
	LDA ($7A),Y		; 99C4	$B1 $7A
	JSR $FD07		; 99C6	$20 $07 $FD
	TAY			; 99C9	$A8
	LDA $8D23,Y		; 99CA	$B9 $23 $8D
	STA $5E			; 99CD	$85 $5E
	LDA $8D33,X		; 99CF	$BD $33 $8D
	STA $61			; 99D2	$85 $61
	LDY #$05		; 99D4	$A0 $05
	LDA ($7A),Y		; 99D6	$B1 $7A
	JSR $FD07		; 99D8	$20 $07 $FD
	TAY			; 99DB	$A8
	LDA $8D03,Y		; 99DC	$B9 $03 $8D
	STA $44			; 99DF	$85 $44
	LDA $8D13,X		; 99E1	$BD $13 $8D
	STA $45			; 99E4	$85 $45
	LDY #$06		; 99E6	$A0 $06
	LDA ($7A),Y		; 99E8	$B1 $7A
	JSR $FD07		; 99EA	$20 $07 $FD
	TAY			; 99ED	$A8
	LDA $8D23,Y		; 99EE	$B9 $23 $8D
	STA $46			; 99F1	$85 $46
	LDA $8D03,X		; 99F3	$BD $03 $8D
	STA $47			; 99F6	$85 $47
	LDY #$07		; 99F8	$A0 $07
	LDA ($7A),Y		; 99FA	$B1 $7A
	...
	TAY			; 99FF	$A8
;; [$9A00 :: 0x31A00]
	LDA $8D13,Y		; 9A00	$B9 $13 $8D
	STA $48			; 9A03	$85 $48
	LDA $8D43,X		; 9A05	$BD $43 $8D
	STA $59			; 9A08	$85 $59
	LDY #$08		; 9A0A	$A0 $08
	LDA ($7A),Y		; 9A0C	$B1 $7A
	JSR $FD07		; 9A0E	$20 $07 $FD
	TAY			; 9A11	$A8
	LDA $8D53,Y		; 9A12	$B9 $53 $8D
	STA $49			; 9A15	$85 $49
	LDA $8D63,X		; 9A17	$BD $63 $8D
	STA $5A			; 9A1A	$85 $5A
	LDY #$09		; 9A1C	$A0 $09
	LDA ($7A),Y		; 9A1E	$B1 $7A
	JSR $FD07		; 9A20	$20 $07 $FD
	TAY			; 9A23	$A8
	LDA $8D23,Y		; 9A24	$B9 $23 $8D
	STA $58			; 9A27	$85 $58
	LDA $8D63,X		; 9A29	$BD $63 $8D
	STA $5B			; 9A2C	$85 $5B
	LDA #$14		; 9A2E	$A9 $14
	STA $4B			; 9A30	$85 $4B
	LDY #$00		; 9A32	$A0 $00
...
; End of Move_OAM_XY
	...
	LDA #$1C		; 9DA1	$A9 $1C
	STA $67			; 9DA3	$85 $67
	JSR $972F		; 9DA5	$20 $2F $97
	LDX #$03		; 9DA8	$A2 $03
L31DAA:
	LDA $9F70,X		; 9DAA	$BD $70 $9F
	STA $62,X		; 9DAD	$95 $62
	DEX			; 9DAF	$CA
	BPL L31DAA		; 9DB0	$10 $F8
	JSR $FD5B		; 9DB2	$20 $5B $FD
	JSR $9250		; 9DB5	$20 $50 $92
...
L31DC1:
	...
	JSR $9490		; 9DD0	$20 $90 $94
	JSR $9E85		; 9DD3	$20 $85 $9E
	LDX #$03		; 9DD6	$A2 $03
L31DD8:
	LDA $9F74,X		; 9DD8	$BD $74 $9F
	STA $62,X		; 9DDB	$95 $62
	DEX			; 9DDD	$CA
	BPL L31DD8		; 9DDE	$10 $F8
	JSR $FD5B		; 9DE0	$20 $5B $FD
	JSR $9250		; 9DE3	$20 $50 $92
	LDA #$40		; 9DE6	$A9 $40
	STA $64			; 9DE8	$85 $64
	LDA #$01		; 9DEA	$A9 $01
	STA $65			; 9DEC	$85 $65
	LDA #$00		; 9DEE	$A9 $00
	STA $63			; 9DF0	$85 $63
	JSR $9AC6		; 9DF2	$20 $C6 $9A
	LDA $76			; 9DF5	$A5 $76
	BNE L31E02		; 9DF7	$D0 $09
	DEC $9E			; 9DF9	$C6 $9E
	LDY #$20		; 9DFB	$A0 $20
	JSR $949B		; 9DFD	$20 $9B $94
...
.byte $9B,$94,$F0,$02,$C6,$9E
L31E76:
	JSR $9A90		; 9E76	$20 $90 $9A
...
;; [$9F70 :: 0x31F70]
.byte $3F,$13,$47,$1E,$28,$13,$3E,$1E
	JSR $FD46		; 9F78	$20 $46 $FD
	JSR $96E1		; 9F7B	$20 $E1 $96
	LDX #$00		; 9F7E	$A2 $00
	LDA #$01		; 9F80	$A9 $01
L31F82:
...
L32006:
.byte $A5,$51,$F0,$0A,$C6,$51,$C6,$50,$20,$BC
.byte $A2,$4C,$96,$9F,$C6,$9E
	LDA #$00		; A016	$A9 $00
	STA $51			; A018	$85 $51
...
; Marks	:
	...
	LDA #$15		; A02B	$A9 $15
	STA $67			; A02D	$85 $67
	JSR $972F		; A02F	$20 $2F $97
	LDA #$05		; A032	$A9 $05
	STA $66			; A034	$85 $66
	LDA #$69		; A036	$A9 $69
	STA $67			; A038	$85 $67
	JSR $972F		; A03A	$20 $2F $97
	LDA #$06		; A03D	$A9 $06
	STA $66			; A03F	$85 $66
	LDA #$20		; A041	$A9 $20
	STA $67			; A043	$85 $67
...
L32129:
	...
	LDA $9E			; A12F	$A5 $9E
	ORA #$80		; A131	$09 $80
	JSR $FAFB		; A133	$20 $FB $FA
	JSR $9A63		; A136	$20 $63 $9A
	JSR $A020		; A139	$20 $20 $A0
	LDY #$20		; A13C	$A0 $20
	JMP $949B		; A13E	$4C $9B $94
; End of
...
L32153:
	...
	PLA			; A157	$68
	CMP #$2F		; A158	$C9 $2F
	BCS L32162		; A15A	$B0 $06
	SEC			; A15C	$38
	SBC #$0E		; A15D	$E9 $0E
	JMP $A18F		; A15F	$4C $8F $A1
L32162:
	CMP #$98		; A162	$C9 $98
	BCC L3216C		; A164	$90 $06
	SEC			; A166	$38
	SBC #$77		; A167	$E9 $77
...
; Marks	:
	...
	LDA #$40		; A252	$A9 $40
	STA $44			; A254	$85 $44
	JSR $9AB6		; A256	$20 $B6 $9A
	JSR $95E7		; A259	$20 $E7 $95
	PLA			; A25C	$68
	TAY			; A25D	$A8
	PLA			; A25E	$68
	TAX			; A25F	$AA
	...
	LDA #$94		; A26D	$A9 $94
	STA $44			; A26F	$85 $44
	JSR $9AB6		; A271	$20 $B6 $9A
	JSR $95E7		; A274	$20 $E7 $95
	PLA			; A277	$68
	TAY			; A278	$A8
	PLA			; A279	$68
	TAX			; A27A	$AA
...
L3228D:
	...
	LDA #$4B		; A298	$A9 $4B
	STA $44			; A29A	$85 $44
	JSR $9AB6		; A29C	$20 $B6 $9A
	JSR $95E7		; A29F	$20 $E7 $95
	PLA			; A2A2	$68
	TAY			; A2A3	$A8
	PLA			; A2A4	$68
	TAX			; A2A5	$AA
	...
	LDA #$75		; A2AD	$A9 $75
	STA $44			; A2AF	$85 $44
	JSR $9AB6		; A2B1	$20 $B6 $9A
	JMP $95E7		; A2B4	$4C $E7 $95
; End of
...
; Name	:
; Marks	:
	JSR $9A90		; A2BC	$20 $90 $9A
	JMP $FAE4		; A2BF	$4C $E4 $FA
; End of
...
.byte $28,$13,$3E,$1E
	...
	JSR $9490		; A310	$20 $90 $94
;A313
.byte $A2,$09,$AC,$4A,$7B,$88,$D0,$01,$E8,$86,$64,$A9,$B2
...
.byte $46,$FD
L32352:
	JSR $A68A		; A362	$20 $8A $A6
	JSR $FD5B		; A365	$20 $5B $FD
	JSR $A741		; A368	$20 $41 $A7
	JMP $905E		; A36B	$4C $5E $90
; End of
...
L323CB:
	...
	SBC #$AA		; A3E9	$E9 $AA
	STA $48			; A3EB	$85 $48
	BCS L323F3		; A3ED	$B0 $04
	LDA #$00		; A3EF	$A9 $00
	STA $48			; A3F1	$85 $48
L323F3:
	LDX #$01		; A3F3	$A2 $01
	LDA #$64		; A3F5	$A9 $64
	JSR $FD11		; A3F7	$20 $11 $FD
	CMP $48			; A3FA	$C5 $48
	BCS L32401		; A3FC	$B0 $03
	JSR $A736		; A3FE	$20 $36 $A7
L32401:
	LDY #$0C		; A401	$A0 $0C
	LDA ($44),Y		; A403	$B1 $44
	INY			; A405	$C8
	ORA ($44),Y		; A406	$11 $44
	BNE L3240D		; A408	$D0 $03
	JSR $A72B		; A40A	$20 $2B $A7
L3240D:
	LDX $76			; A40D	$A6 $76
;A40F
.byte $BD
...
L3285F:
	...
	LDY #$01		; A875	$A0 $01
	SBC ($9F),Y		; A877	$F1 $9F
	BCS L32886		; A879	$B0 $0B
	LDA #$01		; A87B	$A9 $01
	STA $7CB7		; A87D	$8D $B7 $7C
	JSR $ACB1		; A880	$20 $B1 $AC
;A883
.byte $4C,$8C,$A9
L32886:
	JSR $ACC0		; A886	$20 $C0 $AC
...
L32936:
	...
	LDA #$80		; A93C	$A9 $80
	STA $28			; A93E	$85 $28
	JSR $AF85		; A940	$20 $85 $AF	status / damage calc ??
...
L329CA:
	...
	JSR $FACC		; A9DF	$20 $CC $FA	attack animation ?? XOXO ?? Long loop
	LDA #$01		; A9E2	$A9 $01
	STA $2B			; A9E4	$85 $2B
L329E6:
	LDA $E4			; A9E6	$A5 $E4
...
L32A04:
	...
	LDA #$0B		; AA24	$A9 $0B
	STA $55			; AA26	$85 $55
	JSR $ACDD		; AA28	$20 $DD $AC	message text process (hit count) ??
	LDX #$02		; AA2B	$A2 $02
L32A2D:
...
L32A94:
	...
	LDA #$0C		; AA98	$A9 $0C
	STA $55			; AA9A	$85 $55
	JSR $ACDD		; AA9C	$20 $DD $AC	message text process (damage) ??
	LDA #$03		; AA9F	$A9 $03
L32AA1:
	STA $7CD1		; AAA1	$8D $D1 $7C
	JSR Wait_NMI_end	; AAA4	$20 $46 $FD
	JSR Get_player_status1	; AAA7	$20 $71 $AF
	AND #$C0		; AAAA	$29 $C0
...
; Marks	:
	...
	LDA #$00		; AC33	$A9 $00
	STA $6F			; AC35	$85 $6F
	JSR $95E7		; AC37	$20 $E7 $95	text message ??
...
L32EC9:
	...
	INY			; AECF	$C8
	STA ($80),Y		; AED0	$91 $80
	JSR $AF6C		; AED2	$20 $6C $AF
;AED5
.byte $A0,$2C,$91,$80,$A0,$08,$09,$80,$91,$80
L33EDF:
	RTS			; AEDF	$60
...
; Marks	: $9F(ADDR) = player information address base
Get_player_status1:
	LDY #$08		; AF71	$A0 $08
	LDA ($9F),Y		; AF73	$B1 $9F
	RTS			; AF75	$60
...
L330D4:
	LDY #$0A		; B0D4	$A0 $0A
	LDA ($A1),Y		; B0D6	$B1 $A1		current hp L ex> $7E74
	SEC			; B0D8	$38
	SBC $9A			; B0D9	$E5 $9A
	STA ($A1),Y		; B0DB	$91 $A1
	INY			; B0DD	$C8
...
L330EE:
	LDA #$00		; B0EE	$A9 $00
	DEY			; B0F0	$88
	STA ($A1),Y		; B0F1	$91 $A1		current hp L
	INY			; B0F3	$C8
	STA ($A1),Y		; B0F4	$91 $A1		current hp H
	JSR $BF9A		; B0F6	$20 $9A $BF	message / check hp
	JSR Get_enemy_status1	; B0F9	$20 $76 $AF
	LDY #$2C		; B0FC	$A0 $2C
	STA ($A1),Y		; B0FE	$91 $A1		previous status 1(enemy)
	LDY #$08		; B100	$A0 $08
	ORA #$80		; B102	$09 $80		dead(bit7)
	STA ($A1),Y		; B104	$91 $A1		status 1(enemy)
	LDA $28			; B106	$A5 $28
	ORA #$20		; B108	$09 $20
	STA $28			; B10A	$85 $28
L3310C:
...
.byte $60,$A0,$08,$84,$56,$A0,$2C,$84,$5E,$A9,$FE,$85,$57,$D0,$0E
L3335F:
	LDY #$09		; B35F	$A0 $09
	STY $56			; B361	$84 $56
	LDY #$2D		; B363	$A0 $2D
...
L333C0:
	LDA $52			; B3C0	$A5 $52
	JSR $BF5C		; B3C2	$20 $5C $BF
L333C5:
	RTS			; B3C5	$60
; End of

;B3C6
.byte $A9,$00,$85,$4A,$85,$4B,$8D,$AE,$00,$A9
