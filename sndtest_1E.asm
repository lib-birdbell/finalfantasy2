...
UpdataAPU:
	LDA $7F42			; 36/80AB: AD 42 7F  
	BMI B80B1       		; 36/80AE: 30 01        ; branch if music enabled
	RTS             		; 36/80B0: 60        
B80B1:
	LDA $7F4A       		; 36/80B1: AD 4A 7F     ; pulse 1
	BPL B80F5       		; 36/80B4: 10 3F     
	AND #$01        		; 36/80B6: 29 01     
	BEQ B80E0       		; 36/80B8: F0 26        ; branch if not key on
	LDA $7F4A       		; 36/80BA: AD 4A 7F  
	AND #$FE        		; 36/80BD: 29 FE     
	STA $7F4A       		; 36/80BF: 8D 4A 7F  
	LDA $7F89       		; 36/80C2: AD 89 7F     ; duty cycle
	ORA $7F7B       		; 36/80C5: 0D 7B 7F     ; volume
	STA $4000       		; 36/80C8: 8D 00 40  
	LDA $7F82       		; 36/80CB: AD 82 7F     ; sweep
	STA $4001       		; 36/80CE: 8D 01 40  
	LDA $7F6D       		; 36/80D1: AD 6D 7F     ; frequency
	STA $4002       		; 36/80D4: 8D 02 40  
	LDA $7F74       		; 36/80D7: AD 74 7F  
	STA $4003       		; 36/80DA: 8D 03 40  
	JMP B80F5       		; 36/80DD: 4C F5 80  
B80E0:
	LDA $7F89       		; 36/80E0: AD 89 7F     ; duty cycle
	ORA $7F7B       		; 36/80E3: 0D 7B 7F     ; volume
	STA $4000       		; 36/80E6: 8D 00 40  
	LDA $7F82       		; 36/80E9: AD 82 7F     ; sweep
	ASL             		; 36/80EC: 0A        
	BCS B80F5       		; 36/80ED: B0 06     
	LDA $7F6D       		; 36/80EF: AD 6D 7F     ; frequency (lo only)
	STA $4002       		; 36/80F2: 8D 02 40  
B80F5:
	LDA $7F4F       		; 36/80F5: AD 4F 7F  
	BMI B813E       		; 36/80F8: 30 44        ; branch if pulse 2 sound effect active
	LDA $7F4B       		; 36/80FA: AD 4B 7F  
	BPL B813E       		; 36/80FD: 10 3F     
	AND #$01        		; 36/80FF: 29 01     
	BEQ B8129       		; 36/8101: F0 26     
	LDA $7F4B       		; 36/8103: AD 4B 7F  
	AND #$FE        		; 36/8106: 29 FE     
	STA $7F4B       		; 36/8108: 8D 4B 7F  
	LDA $7F8A       		; 36/810B: AD 8A 7F  
	ORA $7F7C       		; 36/810E: 0D 7C 7F  
	STA $4004       		; 36/8111: 8D 04 40  
	LDA $7F83       		; 36/8114: AD 83 7F  
	STA $4005       		; 36/8117: 8D 05 40  
	LDA $7F6E       		; 36/811A: AD 6E 7F  
	STA $4006       		; 36/811D: 8D 06 40  
	LDA $7F75       		; 36/8120: AD 75 7F  
	STA $4007       		; 36/8123: 8D 07 40  
	JMP B813E       		; 36/8126: 4C 3E 81  
B8129:
	LDA $7F8A       		; 36/8129: AD 8A 7F  
	ORA $7F7C       		; 36/812C: 0D 7C 7F  
	STA $4004       		; 36/812F: 8D 04 40  
	LDA $7F83       		; 36/8132: AD 83 7F  
	ASL             		; 36/8135: 0A        
	BCS B813E       		; 36/8136: B0 06     
	LDA $7F6E       		; 36/8138: AD 6E 7F  
	STA $4006       		; 36/813B: 8D 06 40  
B813E:
	LDA $7F4C       		; 36/813E: AD 4C 7F     ; triangle
	BPL B8174       		; 36/8141: 10 31     
	AND #$01        		; 36/8143: 29 01     
	BEQ B8166       		; 36/8145: F0 1F     
	LDA $7F4C       		; 36/8147: AD 4C 7F  
	AND #$FE        		; 36/814A: 29 FE     
	STA $7F4C       		; 36/814C: 8D 4C 7F  
	LDA $7F7D       		; 36/814F: AD 7D 7F  
	ORA #$80        		; 36/8152: 09 80     
	STA $4008       		; 36/8154: 8D 08 40  
	LDA $7F6F       		; 36/8157: AD 6F 7F  
	STA $400A       		; 36/815A: 8D 0A 40  
	LDA $7F76       		; 36/815D: AD 76 7F  
	STA $400B       		; 36/8160: 8D 0B 40  
	JMP B8174       		; 36/8163: 4C 74 81  
B8166:
	LDA $7F7D       		; 36/8166: AD 7D 7F  
	ORA #$80        		; 36/8169: 09 80     
	STA $4008       		; 36/816B: 8D 08 40  
	LDA $7F6F       		; 36/816E: AD 6F 7F  
	STA $400A       		; 36/8171: 8D 0A 40  
B8174:
	LDA $7F50       		; 36/8174: AD 50 7F  
	BMI B81AC       		; 36/8177: 30 33        ; branch if noise sound effect active
	LDA $7F4D       		; 36/8179: AD 4D 7F  
	BPL B81AC       		; 36/817C: 10 2E     
	AND #$01        		; 36/817E: 29 01     
	BEQ B819E       		; 36/8180: F0 1C     
	LDA $7F4D       		; 36/8182: AD 4D 7F  
	AND #$FE        		; 36/8185: 29 FE     
	STA $7F4D       		; 36/8187: 8D 4D 7F  
	LDA $7F7E       		; 36/818A: AD 7E 7F  
	ORA #$30        		; 36/818D: 09 30     
	STA $400C       		; 36/818F: 8D 0C 40  
	LDA $7F70       		; 36/8192: AD 70 7F  
	STA $400E       		; 36/8195: 8D 0E 40  
	STA $400F       		; 36/8198: 8D 0F 40  
	JMP B81AC       		; 36/819B: 4C AC 81  
B819E:
	LDA $7F7E       		; 36/819E: AD 7E 7F  
	ORA #$30        		; 36/81A1: 09 30     
	STA $400C       		; 36/81A3: 8D 0C 40  
	LDA $7F70       		; 36/81A6: AD 70 7F  
	STA $400E       		; 36/81A9: 8D 0E 40  
B81AC:
	LDA $7F4E       		; 36/81AC: AD 4E 7F     ; dmc
	BPL B81C2       		; 36/81AF: 10 11     
	AND #$01        		; 36/81B1: 29 01     
	BEQ B81C2       		; 36/81B3: F0 0D     
	LDA $7F4E       		; 36/81B5: AD 4E 7F  
	AND #$FE        		; 36/81B8: 29 FE     
	STA $7F4E       		; 36/81BA: 8D 4E 7F  
	LDA #$00        		; 36/81BD: A9 00        ; disable dmc
	STA $4011       		; 36/81BF: 8D 11 40  
B81C2:
	RTS             		; 36/81C2: 60        
; End of UpdateAPU
.endif
...
; Name	:
; Marks	: Settings parameter A process(Volume envelopment)
...
; Name	:
; Marks	: Settings parameter B process(Pitch envelopment)
;	  +$C3 = setting A address
...
PlayNote:
	...
	TAY             		; 36/8289: A8        
	LDA NoteDuTbl,Y     		; 36/828A: B9 05 88     ; note duration
	...
	JSR InitDecayC       		; 36/82BD: 20 1D 83     ; init decay counter
...
B82C6:
	...
	ASL             		; 36/82DB: 0A        
	TAY             		; 36/82DC: A8        
	LDA FreqTbl,Y     		; 36/82DD: B9 2D 87     ; frequency table
	STA $7F6D,X     		; 36/82E0: 9D 6D 7F  
	LDA FreqTbl+1,Y     		; 36/82E3: B9 2E 87  
...
B82EA:
	...
	TAY                		; 36/82FF: A8        
	LDA NoiseTble,Y        		; 36/8300: B9 BD 87  ; noise table
...
InitDecayC:
	...
	TAX             		; 36/8321: AA        
	LDA DecayDuTbl,X     		; 36/8322: BD 15 88     ; decay duration
...
B832B:
	...
	TAX             		; 36/8338: AA        
	LDA DecayDuTbl,X     		; 36/8339: BD 15 88  
...
B85B4:
	...
	TAY             		; 36/85BA: A8        
	LDA VolEnvTbl,Y     		; 36/85BB: B9 7C 9A     ; pointers to volume envelope data
	STA $D6         		; 36/85BE: 85 D6     
	LDA VolEnvTbl+1,Y     		; 36/85C0: B9 7D 9A  
	...
	LDA EnvStatJumpTbl,X  		; 36/85D4: BD F4 85     ; envelope state jump table
	STA $D6         		; 36/85D7: 85 D6     
	LDA EnvStatJumpTbl+1,X 		; 36/85D9: BD F5 85  
...
.word EnvStatDR
.word EnvStatDR
;36/85F4: 85FA 8635 8635

; Name	: EnvStatAtk
; Marks	: envelope state 0: attack
EnvStatAtk:
	LDX $D0				; 36/85FA: A6 D0     
	LDY $7FC8,X     		; 36/85FC: BC C8 7F     ; envelope data offset
	LDA ($D8),Y     		; 36/85FF: B1 D8     
	STA $7FE4,X     		; 36/8601: 9D E4 7F     ; set volume envelope value
	INC $7FC8,X     		; 36/8604: FE C8 7F  
	INY             		; 36/8607: C8        
	LDA ($D8),Y     		; 36/8608: B1 D8     
	BPL B8614       		; 36/860A: 10 08        ; branch if not attack terminator
	INC $7FBA,X     		; 36/860C: FE BA 7F     ; increment envelope state (to decay)
	LDA #$00        		; 36/860F: A9 00     
	STA $7FC8,X     		; 36/8611: 9D C8 7F     ; reset envelope data offset
B8614:
	LDA $7F90,X     		; 36/8614: BD 90 7F     ; channel volume
	ASL             		; 36/8617: 0A        
	ASL             		; 36/8618: 0A        
	ASL             		; 36/8619: 0A        
	ASL             		; 36/861A: 0A        
	ORA $7FE4,X     		; 36/861B: 1D E4 7F     ; envelope value
	TAY             		; 36/861E: A8        
	LDA $D2         		; 36/861F: A5 D2        ; sound effects ignore song volume
	BNE B862E       		; 36/8621: D0 0B     
	LDA $7F44       		; 36/8623: AD 44 7F     ; song volume
	ASL             		; 36/8626: 0A        
	ASL             		; 36/8627: 0A        
	ASL             		; 36/8628: 0A        
	ASL             		; 36/8629: 0A        
	ORA VolTbl,Y     		; 36/862A: 19 25 88     ; volume table
	TAY             		; 36/862D: A8        
B862E:
	LDA VolTbl,Y     		; 36/862E: B9 25 88  
	STA $7F7B,X     		; 36/8631: 9D 7B 7F     ; volume
	RTS             		; 36/8634: 60        
; End of EnvStatAtk

; Name	: EnvStatDR
; Marks	: envelope state 1/2: decay/release
;	  envelope value are automatically decreased at every rate
EnvStatDR:
	LDX $D0				; 36/8635: A6 D0     
	LDA $7FE4,X     		; 36/8637: BD E4 7F     ; volume envelope value
	BEQ B8665       		; 36/863A: F0 29        ; key off if envelope reaches zero
	LDY $7FC8,X     		; 36/863C: BC C8 7F     ; data offset
	BNE B864D       		; 36/863F: D0 0C     
	LDA ($D8),Y     		; 36/8641: B1 D8     
	STA $7FD6,X     		; 36/8643: 9D D6 7F     ; set volume envelope rate
	INC $7FC8,X     		; 36/8646: FE C8 7F     ; go to the first envelope value
	TYA             		; 36/8649: 98        
	STA $7FCF,X     		; 36/864A: 9D CF 7F	; Current data offset
B864D:
	LDA $7FD6,X     		; 36/864D: BD D6 7F	; Volume Envelope Rate
	CLC             		; 36/8650: 18        
	ADC $7FDD,X     		; 36/8651: 7D DD 7F	; VER cnt
	STA $7FDD,X     		; 36/8654: 9D DD 7F	; VER cnt
	CMP #$64        		; 36/8657: C9 64     
	BCC B8670       		; 36/8659: 90 15     
	SBC #$64        		; 36/865B: E9 64     
	STA $7FDD,X     		; 36/865D: 9D DD 7F	; VER cnt
	DEC $7FE4,X     		; 36/8660: DE E4 7F     ; decrement envelope value
	BNE B8670       		; 36/8663: D0 0B     
B8665:
	LDA #$03        		; 36/8665: A9 03        ; key off
	STA $7FBA,X     		; 36/8667: 9D BA 7F  
	LDA #$00        		; 36/866A: A9 00     
	STA $7F7B,X     		; 36/866C: 9D 7B 7F     ; set volume to zero
	RTS             		; 36/866F: 60        
B8670:
	LDA $7FE4,X     		; 36/8670: BD E4 7F     ; envelope value
	STA $D5         		; 36/8673: 85 D5	; EV tmp
	LDY $7FC8,X     		; 36/8675: BC C8 7F     ; envelope data offset
	LDA $7FCF,X     		; 36/8678: BD CF 7F	; Current data offset
	BNE B8693       		; 36/867B: D0 16     
	LDA ($D8),Y     		; 36/867D: B1 D8	; first envelope value - loop count
	BEQ B86B5       		; 36/867F: F0 34        ; envelope is terminated
	BPL B868A       		; 36/8681: 10 07     
	CLC             		; 36/8683: 18        
	ADC $7FC8,X     		; 36/8684: 7D C8 7F     ; "subtract" from data offset
	TAY             		; 36/8687: A8        
	LDA ($D8),Y     		; 36/8688: B1 D8     
B868A:
	STA $7FCF,X     		; 36/868A: 9D CF 7F	; Current data offset
	INY             		; 36/868D: C8        
	INY             		; 36/868E: C8        
	TYA             		; 36/868F: 98        
	STA $7FC8,X     		; 36/8690: 9D C8 7F     ; envelope data offset
B8693:
	DEY             		; 36/8693: 88        
	LDA ($D8),Y     		; 36/8694: B1 D8        ; change in volume - volume(+-)
	BMI B86A7       		; 36/8696: 30 0F     
	CLC             		; 36/8698: 18        
	ADC $D5         		; 36/8699: 65 D5	; EV tmp
	STA $D5         		; 36/869B: 85 D5	; EV tmp
	CMP #$10        		; 36/869D: C9 10     
	BCC B86B2       		; 36/869F: 90 11     
	LDA #$0F        		; 36/86A1: A9 0F        ; max 15
	STA $D5         		; 36/86A3: 85 D5	; EV tmp
	BNE B86B2       		; 36/86A5: D0 0B     
B86A7:
	CLC             		; 36/86A7: 18        
	ADC $D5         		; 36/86A8: 65 D5	; EV tmp
	STA $D5         		; 36/86AA: 85 D5	; EV tmp
	BCS B86B2       		; 36/86AC: B0 04	; Normal state is carry set
	LDA #$00        		; 36/86AE: A9 00        ; min 0
	STA $D5         		; 36/86B0: 85 D5	; EV tmp
B86B2:
	DEC $7FCF,X     		; 36/86B2: DE CF 7F	; Current data offset
B86B5:
	LDA $7F90,X     		; 36/86B5: BD 90 7F     ; channel volume
	ASL             		; 36/86B8: 0A        
	ASL             		; 36/86B9: 0A        
	ASL             		; 36/86BA: 0A        
	ASL             		; 36/86BB: 0A        
	ORA $D5         		; 36/86BC: 05 D5	; EV tmp
	TAY             		; 36/86BE: A8        
	LDA $D2         		; 36/86BF: A5 D2        ; sound effects ignore song volume
	BNE B86CE       		; 36/86C1: D0 0B     
	LDA $7F44       		; 36/86C3: AD 44 7F     ; song volume
	ASL             		; 36/86C6: 0A        
	ASL             		; 36/86C7: 0A        
	ASL             		; 36/86C8: 0A        
	ASL             		; 36/86C9: 0A        
	ORA VolTbl,Y     		; 36/86CA: 19 25 88     ; volume table
	TAY             		; 36/86CD: A8        
B86CE:
	LDA VolTbl,Y     		; 36/86CE: B9 25 88  
	STA $7F7B,X     		; 36/86D1: 9D 7B 7F     ; volume
	RTS             		; 36/86D4: 60        
; End of EnvStatDR
...
UpdatePitEnv:
	...
	TAY             		; 36/86DD: A8        
	LDA PitEnvTbl,Y     		; 36/86DE: B9 AB 9E     ; pointers to pitch envelope data
	STA $D8         		; 36/86E1: 85 D8     
	LDA PitEnvTbl+1,Y     		; 36/86E3: B9 AC 9E  
...
FreqTbl:
.word $06AB,$064D,$05F3,$059D,$054C,$0501,$04B8,$0474
.word $0434,$03F7,$03BE,$0388,$0355,$0326,$02F9,$02CE
.word $02A6,$0280,$025C,$023A,$0219,$01FB,$01DE,$01C4
.word $01AA,$0193,$017C,$0167,$0152,$013F,$012D,$011C
.word $010C,$00FD,$00EF,$00E1,$00D5,$00C9,$00BE,$00B3
.word $00A9,$009F,$0096,$008E,$0086,$007E,$0077,$0070
.word $006A,$0064,$005E,$0059,$0054,$004F,$004B,$0046
.word $0042,$003E,$003B,$0038,$0034,$0031,$002F,$002C
.word $0029,$0027,$0025,$0023,$0021,$001F,$001D,$001B

;06AB 064D 05F3 059D 054C 0501 04B8 0474	36/872D:
;0434 03F7 03BE 0388 0355 0326 02F9 02CE        36/873D:
;02A6 0280 025C 023A 0219 01FB 01DE 01C4        36/874D:
;01AA 0193 017C 0167 0152 013F 012D 011C        36/875D:
;010C 00FD 00EF 00E1 00D5 00C9 00BE 00B3        36/876D:
;00A9 009F 0096 008E 0086 007E 0077 0070        36/877D:
;006A 0064 005E 0059 0054 004F 004B 0046        36/878D:
;0042 003E 003B 0038 0034 0031 002F 002C        36/879D:
;0029 0027 0025 0023 0021 001F 001D 001B        36/87AD:

; noise table
NoiseTble:
.byte $00,$01,$02,$03,$04,$05,$06,$07,$08,$09,$0A,$0B	; 36/87BD:
.byte $0C,$0E,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F	; 36/87C9:
.byte $80,$81,$82,$83,$84,$85,$86,$87,$88,$89,$8A,$8B	; 36/87D5:
.byte $8C,$8E,$8F,$8F,$8F,$8F,$8F,$8F,$8F,$8F,$8F,$8F	; 36/87E1:
.byte $04,$04,$04,$04,$04,$04,$04,$04,$04,$04,$04,$04	; 36/87ED:
.byte $0B,$0B,$0B,$0B,$0B,$0B,$0B,$0B,$0B,$0B,$0B,$0B	; 36/87F9:

; note durations
NoteDuTbl:
.byte $60  ; 36/8805: 00: whole note
.byte $48  ; 36/8806: 01: dotted half note
.byte $30  ; 36/8807: 02: half note
.byte $24  ; 36/8808: 03: dotted quarter note
.byte $20  ; 36/8809: 04: quarter note triplet
.byte $18  ; 36/880A: 05: quarter note
.byte $12  ; 36/880B: 06: dotted eighth note
.byte $10  ; 36/880C: 07: eighth note triplet
.byte $0C  ; 36/880D: 08: eighth note
.byte $09  ; 36/880E: 09: dotted 16th note
.byte $08  ; 36/880F: 0A: 16th note triplet
.byte $06  ; 36/8810: 0B: 16th note
.byte $04  ; 36/8811: 0C: 32nd note triplet
.byte $03  ; 36/8812: 0D: 32nd note
.byte $02  ; 36/8813: 0E: 64th note triplet
.byte $01  ; 36/8814: 0F: 128th note triplet

; decay durations
DecayDuTbl:
.byte $48,$36,$24,$1B,$18,$12,$0D,$0C,$09,$07,$06,$04,$03,$02,$01,$00
;36/8815: 48 36 24 1B 18 12 0D 0C 09 07 06 04 03 02 01 00

; volume table (16 items, 16 bytes each)
VolTbl:
.byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00	;,$36/8825:;,$muted
.byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$01	;,$36/8835:
.byte $00,$00,$00,$00,$00,$00,$00,$00,$01,$01,$01,$01,$01,$01,$01,$02	;,$36/8845:
.byte $00,$00,$00,$00,$00,$01,$01,$01,$01,$01,$02,$02,$02,$02,$02,$03	;,$36/8855:
.byte $00,$00,$00,$00,$01,$01,$01,$01,$02,$02,$02,$02,$03,$03,$03,$04	;,$36/8865:
.byte $00,$00,$00,$01,$01,$01,$02,$02,$02,$03,$03,$03,$04,$04,$04,$05	;,$36/8875:
.byte $00,$00,$00,$01,$01,$02,$02,$02,$03,$03,$04,$04,$04,$05,$05,$06	;,$36/8885:
.byte $00,$00,$00,$01,$01,$02,$02,$03,$03,$04,$04,$05,$05,$06,$06,$07	;,$36/8895:
.byte $00,$00,$01,$01,$02,$02,$03,$03,$04,$04,$05,$05,$06,$06,$07,$08	;,$36/88A5:
.byte $00,$00,$01,$01,$02,$03,$03,$04,$04,$05,$06,$06,$07,$07,$08,$09	;,$36/88B5:
.byte $00,$00,$01,$02,$02,$03,$04,$04,$05,$06,$06,$07,$08,$08,$09,$0A	;,$36/88C5:
.byte $00,$00,$01,$02,$02,$03,$04,$05,$05,$06,$07,$08,$08,$09,$0A,$0B	;,$36/88D5:
.byte $00,$00,$01,$02,$03,$04,$04,$05,$06,$07,$08,$08,$09,$0A,$0B,$0C	;,$36/88E5:
.byte $00,$00,$01,$02,$03,$04,$05,$06,$06,$07,$08,$09,$0A,$0B,$0C,$0D	;,$36/88F5:
.byte $00,$00,$01,$02,$03,$04,$05,$06,$07,$08,$09,$0A,$0B,$0C,$0D,$0E	;,$36/8905:
.byte $00,$01,$02,$03,$04,$05,$06,$07,$08,$09,$0A,$0B,$0C,$0D,$0E,$0F	;,$36/8915:;,$full,$volume
...
.byte D12ICV00
.word VPBD43
;.word APBEC7	; debug commented
.byte $FF,$FF	; deprecated
BGM_FIELD_CH0_R0:
.byte TEMPO,$34
FF2_FIELD_CH0_NEW:
.byte OT1,L1_24,C1_24,OT2,D1_24,R1_32,M1_32,FH1_32,SH1_32		; 1/4
...
; XXXX PYYY : XXXX is count
;	      if XXXX is exist, PYYY is +- (P is +,- YYYY is value)
;	      if XXXX is 0, PYYY is return value
;	      00h is End
APBEAF:
.byte $1B
...
.byte $F0,$0B
.byte $E0,$53
.byte $2B,$E0,$55,$4B,$E0,$57,$7B,$E0,$59,$F1,$0B,$E0,$5B,$2B,$E0,$5D
.byte $4B,$E0,$5F,$7B,$F2,$0B,$2B,$4B,$7B,$F3,$0B,$2B,$4B,$7B,$FB,$02
M_A0B0_CH0_2:
.byte $F4,$0B,$F3,$7B,$4B,$2B,$0B,$F2,$7B,$4B,$2B,$0B,$F1,$7B,$4B,$2B
.byte $0B,$F0,$7B,$4B,$2B,$EF,$9B,$BB,$F0,$0B,$4B,$9B,$BB,$F1,$0B,$4B
.byte $9B,$BB,$F2,$0B,$4B,$9B,$BB,$F3,$0B,$4B,$9B,$4B,$0B,$F2,$BB,$9B
.byte $4B,$0B,$F1,$BB,$9B,$4B,$0B,$F0,$BB,$9B,$4B,$0B,$EF,$BB
.byte JUMP_Z
.word M_A108_CH0_1
;.byte $FD,$08
;.byte $A1
.byte $F0,$0B,$2B,$4B,$7B,$F1,$0B,$2B,$4B,$7B,$F2,$0B,$2B,$4B,$7B
...
.word M_A0B0_CH0_2
M_A108_CH0_1:
.byte $9B,$F0,$0B,$5B,$7B,$9B,$F1,$0B
.byte $5B,$7B,$9B,$F2,$0B,$5B,$7B,$9B,$F3,$0B,$5B,$7B,$9B,$7B,$5B,$0B
.byte $F2,$9B,$7B,$5B,$0B,$F1,$9B,$7B,$5B,$0B,$F0,$9B,$7B,$5B,$0B,$EF
.byte $BB,$F0,$2B,$7B,$9B,$BB,$F1,$2B,$7B,$9B,$BB,$F2,$2B,$7B,$9B,$BB
.byte $F3,$2B,$7B,$9B,$BB,$9B,$7B,$2B,$F2,$BB,$9B,$7B,$2B,$F1,$BB,$9B
.byte $7B,$2B,$F0,$BB,$9B,$7B,$2B,$EF,$8B,$F0,$0B,$3B,$7B,$8B,$F1,$0B
.byte $3B,$7B,$8B,$F2,$0B,$3B,$7B,$8B,$F3,$0B,$3B,$7B,$8B,$7B,$3B,$0B
.byte $F2,$8B,$7B,$3B,$0B,$F1,$8B,$7B,$3B,$0B,$F0,$8B,$7B,$3B,$0B,$EF
.byte $AB,$F0,$2B,$5B,$9B,$AB,$F1,$2B,$5B,$9B,$AB,$F2,$2B,$5B,$9B,$AB
.byte $F3,$2B,$5B,$9B,$E0,$5E,$AB,$E0,$5D,$9B,$E0,$5C,$5B,$E0,$5B,$2B
.byte $E0,$5A,$F2,$AB,$E0,$59,$9B,$E0,$58,$5B,$E0,$57,$2B,$E0,$55,$F1
.byte $AB,$E0,$53,$9B,$E0,$51,$5B,$E0,$4F,$2B,$E0,$4C,$F0,$AB,$E0,$49
.byte $9B,$E0,$46,$5B,$E0,$43,$2B
.byte JUMP
.word M_A07C_CH0_S
;.word $8A,$A0
;A1CA - CH1
...
; ==================================================
; Final Fantasy 2 Airship ORIGINAL(FF3 DRIVER)
BGM_AIRSHIP:
.word BGM_AIRSHIP_CH0
.word BGM_AIRSHIP_CH1
.word BGM_AIRSHIP_TRI
...
.byte TEMPO,$96
BGM_AIRSHIP_CH0_R0:
.byte OT1,L1_2,OT2,D1_2
.byte OT1,LH1_2,L1_2
.byte OT2,R1_4,OT1,S1_2,L1_4
.byte S1_2,S1_8,C1_8,OT2,R1_8,F1_8
...
.byte F1_4,OT1,LH1_4,X1_8,OT2,D1_8,R1_4
.byte R1_2,OT1,LH1_4,OT2,R1_4
.byte D3_8,OT1,L1_8,L1_2
.byte X1_2,X1_8,OT2,R1_8,R1_8,M1_8
...
;.byte TEMPO,$96
BGM_AIRSHIP_CH1_R0:
.byte OT0,L1_16,OT1,D1_16,R1_16,M1_16,F1_16,M1_16,R1_16,D1_16,OT0,S1_16,OT1,D1_16,R1_16,M1_16,S1_16,M1_16,R1_16,D1_16
.byte OT0,LH1_16,OT1,D1_16,R1_16,M1_16,F1_16,M1_16,R1_16,D1_16,OT0,L1_16,OT1,D1_16,R1_16,M1_16,F1_16,M1_16,R1_16,D1_16
.byte R1_2,D1_2
.byte OT0,C1_2,X1_2

.byte OT1,S1_8,M1_8,S1_8,M1_8,S1_8,M1_8,S1_8,M1_8
.byte S1_8,M1_8,S1_8,M1_8,S1_8,M1_8,S1_8,M1_8
.byte R1_8,OT0,L1_8,OT1,F1_8,OT0,L1_8,OT1,DH1_8,OT0,L1_8,OT1,F1_8,OT0,L1_8
.byte OT1,D1_8,OT0,L1_8,OT1,F1_8,OT0,L1_8,C1_8,L1_8,OT1,F1_8,OT0,L1_8
...
BGM_AIRSHIP_TRI:
BGM_AIRSHIP_TRI_R0:
.byte OT1,F1_16,X1_16,F1_16,X1_16,X1_8,F1_8,M1_16,X1_16,M1_16,X1_16,X1_8,M1_8
.byte R1_16,X1_16,R1_16,X1_16,X1_8,R1_8,D1_16,X1_16,D1_16,X1_16,X1_8,D1_8
.byte OT0,C1_8,OT1,S1_8,OT0,C1_8,OT1,S1_8,D1_8,S1_8,D1_8,S1_8
.byte DH1_8,S1_8,DH1_8,S1_8,R1_8,S1_8,R1_8,S1_8

.byte D1_8,S1_8,D1_8,S1_8,D1_8,S1_8,D1_8,S1_8
.byte DH1_8,L1_8,DH1_8,L1_8,DH1_8,L1_8,DH1_8,L1_8
.byte R1_16,X1_16,R1_16,X1_16,X1_8,R1_16,X1_16,DH1_16,X1_16,DH1_16,X1_16,X1_8,DH1_16,X1_16
.byte D1_16,X1_16,D1_16,X1_16,X1_8,D1_16,X1_16,OT0,C1_16,X1_16,C1_16,X1_16,X1_8,C1_16,X1_16

.byte LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8
.byte OT0,LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8,OT0,LH1_8,OT1,LH1_8
.byte OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8
.byte OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8,OT0,L1_8,OT1,L1_8

.byte OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8
.byte OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8,OT0,S1_8,OT1,S1_8
.byte D1_8,S1_8,D1_8,S1_8,D1_8,S1_8,D1_8,S1_8
.byte D1_8,S1_8,D1_8,S1_8,D1_8,S1_8,D1_8,S1_8
...
;==================================================
; Final Fantasy 2 Main thema(Field) SR (FF3 DRIVER)
;
BGM_FIELD:
.word BGM_FIELD_CH0
.if 1
...
.word BGM_FIELD_TRI_NEW_R0
BGM_FIELD_TRI_NEW_R1:
.byte TEMPO,$66,OT2,D1_8,OT3,D1_8,TEMPO,$64,RH1_8,S1_8		; 16 added
.byte TEMPO,$62,OT2,SH1_8,OT3,RH1_8,TEMPO,$60,SH1_8,OT4,D1_8					; 16 added
.byte TEMPO,$5E,OT2,S1_8,TEMPO,$5C,OT3,R1_8		; added
...
BGM_FFL1_FIELD:
;.byte $FF,$FF
.word BGM_FFL1_FIELD_CH0
.word BGM_FFL1_FIELD_CH1
;.byte $FF,$FF
...
.byte VOL15
.byte TEMPO,$88
BGM_FFL1_FIELD_CH0_S:
;F->FH
.byte OT1,S1_12,X1_12,S1_12,OT2,R1_4,X1_4,D1_12,R1_12,M1_12	; 3sim
;.byte R1_4,OT1,S1_4,OT2,FH1_12,X1_12,M1_12,R1_12,X1_12,D1_12
.byte R1_4,OT1,S1_4,OT2,FH1_12,X1_6,R1_12,X1_12,D1_12

.byte OT1,C1_12,X1_12,C1_12,OT2,FH1_4,X1_4,M1_12,FH1_12,S1_12
.byte FH1_4,OT1,C1_4,OT2,L1_12,X1_12,S1_12,FH1_12,X1_12,M1_12

.byte R1_12,OT1,C1_12,OT2,D1_12,R1_2,OT1,C1_12,C1_12,OT2,D1_12
.byte R1_4,F1_4,M1_4,R1_4
.byte D1_12,OT1,L1_12,C1_12,OT2,D1_2,OT1,L1_12,L1_12,C1_12
.byte OT2,D1_4,RH1_4,R1_4,D1_4

.byte OT1,C1_4,C1_6,OT2,D1_12,R1_4,L1_4
.byte R3_4,R1_12,D1_12,OT1,C1_12

.byte L1_4,L1_6,C1_12,OT2,D1_4,FH1_4
.byte R1
...
.byte OT2,D1_4,D1_6,R1_12,M1_4,FH1_4
.byte S1_4,M1_4,FH1_4,L1_4

;.byte F1_4,X1_2,F1_12,M1_12,R1_12
.byte F3_4,F1_12,M1_12,R1_12
.byte M1_12,X1_12,OT1,C1_12,C1_2,X1_4
;.byte OT2,RH1_4,X1_2,RH1_12,R1_12,D1_12
.byte OT2,RH3_4,RH1_12,R1_12,D1_12
.byte R1_12,X1_12,OT1,L1_12,L1_2,X1_4

.byte OT2,R3_4,R1_12,D1_12,OT1,C1_12
.byte OT2,D1_12,X1_12,OT1,L1_12,L1_2,L1_12,X1_12,C1_12
.byte OT2,D1_2,X1_4,OT1,L1_12,C1_12,OT2,D1_12		; 3sim

.byte R1_12,R1_12,X1_12,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24
.byte R1

.byte JUMP
.word BGM_FFL1_FIELD_CH0_S

BGM_FFL1_FIELD_CH1:
.byte DUTY_1_4,$04,$07
.byte VOL15
;.byte TEMPO,$96
BGM_FFL1_FIELD_CH1_S:
;F->FH
.byte OT1,R1_12,X1_6,C1_4,L1_12,S1_12,FH1_12,M1_12,X1_6	; 3sim
;.byte C1_4,R1_4,OT2,DH1_12,X1_6,OT1,FH1_12,X1_6
.byte C1_4,R1_4,OT2,DH1_12,X1_12,M1_12,OT1,FH1_12,X1_6

.byte R1_12,X1_6,OT2,R1_4,DH1_12,OT1,C1_12,L1_12,S1_12,X1_6
.byte OT2,R1_4,OT1,FH1_4,OT2,M1_12,X1_6,OT1,L1_12,C1_12,OT2,D1_12

.byte OT1,C1_12,S1_12,M1_12,R1_2,X1_12,S1_12,L1_12
.byte C1_4,L1_4,SH1_4,C1_4
.byte L1_12,M1_12,D1_12,L1_2,X1_12,D1_12,M1_12
.byte RH1_4,S1_4,FH1_4,L1_4

.byte S1_2,L1_4,OT2,D1_4
.byte OT1,C1_4,L1_4,SH1_4,SH1_12,SH1_12,R1_12

.byte D1_4,M1_4,S1_4,L1_4
.byte FH1_4,S1_4,SH1_4,L1_4


.byte S1_2,L1_4,OT2,D1_4
.byte OT1,C1_4,L1_4,SH1_4,SH1_12,SH1_12,R1_12

.byte M1_4,L1_4,SH1_4,C1_4
.byte OT2,D1_12,OT1,L1_12,OT2,D1_12,OT1,L1_12,M1_12,L1_12,OT2,R1_12,OT1,L1_12,OT2,R1_12,OT1,L1_12,OT2,R1_12,FH1_12

.byte OT1,F1_4,OT0,L1_12,OT1,R1_12,M1_12,F1_4,L1_4
.byte SH3_4,OT0,SH1_12,L1_12,C1_12
.byte OT1,RH1_4,OT0,S1_12,OT1,D1_12,R1_12,RH1_4,S1_4
.byte FH3_4,OT0,FH1_12,S1_12,L1_12

.byte OT1,F1_12,R1_12,F1_12,L1_12,F1_12,L1_12,C1_12,SH1_12,C1_12,SH1_12,SH1_12,R1_12
.byte M1_12,X1_12,D1_12,D1_2,M1_12,X1_12,SH1_12
.byte L1_12,SH1_24,F1_24,M1_12,R1_12,D1_12,OT0,L1_12,OT1,F1_12,M1_12,R1_12,D1_4		; 3sim

.byte OT1,S1_12,S1_12,X1_12,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24,S1_24,X1_24
.byte FH1_4,FH1_24,X1_24,FH1_24,X1_24,FH1_24,X1_24,FH1_2

.byte JUMP
.word BGM_FFL1_FIELD_CH1_S

BGM_FFL1_FIELD_TRI:
.byte OT1,S1_8,X1_8,S1_8,X1_8,S1_8,X1_8,S1_8,X1_8
.byte S1_8,X1_8,S1_8,X1_8,FH1_8,X1_8,FH1_8,X1_8

.byte C1_8,X1_8,C1_8,X1_8,C1_8,X1_8,C1_8,X1_8
.byte C1_8,X1_8,C1_8,X1_8,OT2,D1_8,X1_8,D1_8,X1_8

.byte OT1,S1_8,X1_8,OT2,S1_4,OT1,S1_12,X1_12,S1_12,OT2,S1_4
.byte OT1,F1_8,X1_8,OT2,F1_4,OT1,F1_12,X1_12,F1_12,OT2,F1_4
.byte OT1,L1_8,X1_8,OT2,M1_4,OT1,L1_12,X1_12,L1_12,OT2,M1_4
.byte OT2,RH1_12,X1_12,RH1_12,OT1,L1_4,OT2,R1_12,X1_12,R1_12,OT1,L1_4

.byte S1_12,X1_12,S1_12,S1_12,X1_12,S1_12,FH1_12,X1_12,FH1_12,FH1_12,X1_12,FH1_12
.byte F1_12,X1_12,F1_12,F1_12,X1_12,F1_12,M1_12,X1_12,M1_12,M1_12,X1_12,M1_12

.byte L1_12,X1_12,L1_12,L1_12,X1_12,L1_12,S1_12,X1_12,S1_12,S1_12,X1_12,S1_12
.byte R1_12,X1_12,R1_12,M1_12,X1_12,M1_12,F1_12,X1_12,F1_12,FH1_12,X1_12,FH1_12

.byte S1_12,X1_12,S1_12,S1_12,X1_12,S1_12,FH1_12,X1_12,FH1_12,FH1_12,X1_12,FH1_12
.byte F1_12,X1_12,F1_12,F1_12,X1_12,F1_12,M1_12,X1_12,M1_12,M1_12,X1_12,M1_12

.byte L1_12,X1_12,L1_12,L1_12,X1_12,L1_12,SH1_12,X1_12,SH1_12,SH1_12,X1_12,SH1_12
.byte S1_12,X1_12,S1_12,S1_12,X1_12,S1_12,FH1_12,X1_12,FH1_12,FH1_12,X1_12,FH1_12

.byte OT2,R1_4,OT1,R1_12,F1_12,L1_12,OT2,R1_4,F1_4
.byte M1_4,OT1,C1_24,X1_24,C1_24,X1_24,C1_24,X1_24,M1_2
.byte OT2,D1_4,OT1,D1_12,RH1_12,S1_12,OT2,D1_4,RH1_4
.byte R1_4,OT1,L1_24,X1_24,L1_24,X1_24,L1_24,X1_24,R1_2

.byte C1_4,L1_4,SH1_4,OT2,M1_4
.byte OT1,L1_4,OT2,S1_4,F1_4,M1_4
.byte F1_4,M1_4,R1_4,D1_4

.byte R1_12,OT1,L1_24,C1_24,OT2,D1_12,R1_12,M1_12,FH1_12,S1_12,L1_12,C1_12,OT3,D1_12,R1_12,M1_12
.byte R1_4,OT2,R1_24,X1_24,R1_24,X1_24,R1_24,X1_24,R1_4,OT1,R1_4
...
; ==================================================
; Final Fantasy 2 Shop
BGM_FF2_SHOP:
.word BGM_FF2_SHOP_CH0
.word BGM_FF2_SHOP_CH1
.word BGM_FF2_SHOP_TRI
.byte $FF,$FF,$FF,$FF
BGM_FF2_SHOP_CH0:
;.byte DUTY_1_2,$29,$13
.byte DUTY_1_8,$29,$13
...
.byte OT2,M1_8
BGM_FF2_SHOP_CH0_S:
.byte OT3,DH1_4,D1_8,DH1_4,M1_8
.byte DH3_8,X1_4,OT2,M1_8
.byte OT3,DH1_4,D1_8,DH1_4,M1_8
.byte R3_8,X1_4,OT2,FH1_8

.byte OT3,R1_4,DH1_8,R1_4,FH1_8
.byte R3_8,X1_4,OT2,FH1_8
.byte OT3,R1_4,DH1_8,R1_4,FH1_8
.byte M3_8,X1_4,OT2,M1_8

.byte JUMP
.word BGM_FF2_SHOP_CH0_S
BGM_FF2_SHOP_CH1:
;.byte DUTY_1_2,$29,$13
.byte DUTY_1_8,$29,$13
.byte VOL15
...
.byte X1_8
BGM_FF2_SHOP_CH1_S:
.byte OT2,DH1_4,R1_8,M1_4,SH1_8
.byte L1_8,SH1_16,L1_16,M1_16,R1_16,DH1_16,X1_16,OT1,L1_16,X3_16
.byte OT2,DH1_4,R1_8,M1_4,L1_8
.byte C1_8,LH1_16,C1_16,FH1_16,M1_16,R1_16,X1_16,DH1_16,X3_16

.byte R1_4,M1_8,FH1_4,LH1_8
.byte C1_8,LH1_16,C1_16,FH1_16,M1_16,R1_16,X1_16,DH1_16,X1_16,M1_16,X1_16
.byte C1_8,FH1_8,FH1_8,S1_8,C1_8,L1_8
.byte SH1_4,FH1_16,M1_16,R1_24,M1_24,R1_24,DH1_24,R1_24,DH1_24,OT1,C1_24,OT2,DH1_24,OT1,C1_24

.byte JUMP
.word BGM_FF2_SHOP_CH1_S

BGM_FF2_SHOP_TRI:
;F->FH,S->SH,D->DH
.byte X1_8
BGM_FF2_SHOP_TRI_S:
.byte OT1,L1_16,X1_16,OT2,M1_16,X1_16,M1_16,X1_16,OT1,L1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16
.byte OT1,L1_16,X1_16,OT2,SH1_16,X1_16,SH1_16,X1_16,OT1,L1_16,X1_16,FH1_16,X1_16,FH1_16,X1_16
.byte OT1,L1_16,X1_16,OT2,M1_16,X1_16,M1_16,X1_16,OT1,L1_16,X1_16,OT2,SH1_16,X1_16,SH1_16,X1_16
.byte OT1,C1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16,OT1,LH1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16

.byte OT1,C1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16,OT1,LH1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16
.byte OT1,C1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16,OT1,LH1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16
.byte OT1,C1_16,X1_16,OT2,FH1_16,X1_16,FH1_16,X1_16,OT1,C1_16,X1_16,OT2,S1_16,X1_16,S1_16,X1_16
.byte OT1,C1_16,X1_16,OT2,SH1_16,X1_16,SH1_16,X1_16,R1_16,X1_16,SH1_16,X1_16,SH1_16,X1_16

.byte JUMP
.word BGM_FF2_SHOP_TRI_S



; ==================================================
; Final Fantasy 2 Battle Scene A
BGM_FF2_BATTLE_A:
.word BGM_FF2_BATTLE_A_CH0
.word BGM_FF2_BATTLE_A_CH1
;.byte $FF,$FF
.word BGM_FF2_BATTLE_A_TRI
.byte $FF,$FF,$FF,$FF
BGM_FF2_BATTLE_A_CH0:
.byte DUTY_1_4,$02,$FF
.byte VOL15
.byte TEMPO,$96
BGM_FF2_BATTLE_A_CH0_S:
;D->DH,F->FH,S->SH
.byte OT1,FH1_8,X1_16,FH3_16,FH1_8,SH1_8,X1_16,SH3_16,SH1_8
.byte L1_8,X1_16,L3_16,L1_8,C1_8,X1_16,C3_16,C1_8
.byte OT2,R1_8,X1_16,R3_16,R1_8,M1_8,X1_16,M3_16,M1_8
.byte X1_4,FH1_4,SH1_4,SH1_4

.byte OT1,FH1_8,SH1_8,L1_8,C1_8,OT2,DH1_4,OT1,L1_8,OT2,M1_8
.byte RH1_2,OT1,C1_4,M1_4
;.byte RH1_2,OT1,FH1_4,M1_4
.byte RH3_8,FH1_2,FH1_8
.byte FH1

.byte FH1_8,SH1_8,L1_8,C1_8,OT2,DH1_4,OT1,L1_8,OT2,M1_8
.byte RH1_2,OT1,C1_4,M1_4
.byte RH3_8,C1_2,C1_8
.byte C1
.byte OT2,R1_8,OT1,C1_8,OT2,DH1_8,R3_8,DH1_8,OT1,C1_8
.byte C1_8,SH1_8,L1_8,C1_8,C1_4,L1_8,SH1_8
.byte SH3_8,M1_2,M1_8
.byte M1
.byte OT2,R1_8,OT1,C1_8,OT2,DH1_8,R3_8,DH1_8,OT1,C1_8

.byte C1_8,SH1_8,L1_8,C1_8,C1_4,L1_8,SH1_8
.byte SH3_8,OT2,M1_2,M1_8
.byte M1
.byte OT1,F1_8,X1_8,FH1_8,X1_8,SH1_8,X1_8,FH1_8,X1_8
.byte C1_8,X1_8,L1_8,X1_8,OT2,R1_8,X1_8,OT1,DH1_8,FH1_8
.byte F1_2,F1_8,SH3_16,F3_16
.byte R1_2,R1_8,SH3_16,F3_16
.byte OT0,C1_2,C1_8,OT1,R3_16,OT0,C3_16
.byte SH1_2,SH1_2

.byte OT1,FH3_8,OT2,DH1_8,M1_2
.byte M1_8,SH1_4,M1_8,DH1_8,OT1,C1_8,OT2,DH1_8,M1_8
.byte OT1,FH3_8,OT2,DH1_8,OT1,C1_8,FH3_8

.byte SH3_16,C3_16,OT2,DH1_8,M3_16,OT1,C3_16,SH1_8
.byte FH3_8,OT2,DH1_8,M1_2
.byte M1_8,SH1_4,M1_8,DH1_8,OT1,C1_8,OT2,DH1_8,M1_8
.byte OT1,FH3_8,OT2,DH1_8,OT1,C1_8,FH3_8
.byte FH3_16,SH3_16,L1_8,C3_16,OT2,DH3_16,M1_8
.byte OT1,M3_8,OT2,DH1_8,M1_2
.byte M1_8,SH1_4,M1_8,DH1_8,OT1,C1_8,OT2,DH1_8,M1_8
...
.byte OT1,FH3_8,OT2,DH1_8,OT1,C1_8,FH3_8
.byte FH3_16,SH3_16,L1_8,C3_16,OT2,DH3_16,M1_8
.byte OT1,FH3_16,SH3_16,L1_8,SH3_16,FH3_16,M1_8

.byte OT2,DH3_16,OT1,FH3_16,L1_8,SH3_16,FH3_16,M1_8
.byte FH3_16,SH3_16,L1_8,SH3_16,FH3_16,M1_8

; VER 1
.if 0
.byte OT1,FH1_8,FH1_4,FH1_8,SH1_8,SH1_8,X1_4
.byte L1_8,L1_4,L1_8,C1_4,X1_4
.byte OT2,R1_8,R1_4,R1_8,M1_4,X1_4
.byte X1_4,FH1_4,SH1_4,SH1_4
.byte OT1,FH1_8,SH1_8,L1_8,C1_8,OT2,DH1_4,OT1,L1_8,OT2,M1_8
.byte R1_2,OT1,C1_4,M1_4
.byte RH3_8,FH1_2,FH1_8
.byte FH1
...
.byte SH3_8,OT2,M1_2,M1_8
.byte M1
.byte OT1,F1_4,FH1_4,SH1_4,FH1_4		; . . . .
.byte C1_4,L1_4,OT2,R1_4,OT1,DH1_8,FH1_8	; . . .
.byte F1_2,F1_8,SH3_16,F3_16
.byte R1_2,R1_8,SH3_16,F3_16
.byte OT0,C1_2,C1_8,OT1,R3_16,OT0,C3_16
.byte SH1_2,SH1_2
...
.byte JUMP
.word BGM_FF2_BATTLE_A_CH0_S

BGM_FF2_BATTLE_A_CH1:
.byte DUTY_1_4,$02,$FF
.byte VOL15

BGM_FF2_BATTLE_A_CH1_S:
.byte OT1,FH1_16,M1_16,R1_16,FH1_16,M1_16,R1_16,FH1_16,M1_16
;C1_24,L1_24,S1_24,C1_24,L1_24,S1_24,C1_24,L1_24,S1_24,C1_24,L1_24,S1_24,C1_24,L1_24,S1_24,C1_24,L1_24,S1_24,C1_24,L1_24,S1_24

.byte JUMP
.word BGM_FF2_BATTLE_A_CH1_S

BGM_FF2_BATTLE_A_TRI:
.byte OT0
BGM_FF2_BATTLE_A_TRI_S:
...
;==========
BGM_FF2_THE_MAGIC_HOUSE:
.word BGM_FF2_THE_MAGIC_HOUSE_CH0
.if 1
.word BGM_FF2_THE_MAGIC_HOUSE_CH1
.else
.byte $FF,$FF
.endif
.if 1
.word BGM_FF2_THE_MAGIC_HOUSE_TRI
.else
.byte $FF,$FF
.endif
.if 0
.word BGM_FF2_THE_MAGIC_HOUSE_NOI
.else
.byte $FF,$FF
.endif
.if 0
.word BGM_FF2_THE_MAGIC_HOUSE_DMC
.else
.byte $FF,$FF
.endif

BGM_FF2_THE_MAGIC_HOUSE_CH0:
.byte DUTY_1_4,$04,$04				; Flute
.byte VOL15
.byte TEMPO,$64					; (A,100)

;temp start
.if 0
.byte DUTY_1_2,$03,$00				; Flute - 04$02,0203,020d,0207,0209,0211
.byte VOL15
BGM_R_TEMP:
.if 0
.byte X1_2,X3_8,OT2,L1_16,C1_16			;
.byte OT3,D1_16,R1_16,OT2,C1_16,OT3,R1_16,OT2,L1_16,OT3,R1_16,OT2,SH1_16,OT3,R1_16, OT2,L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16				; [-_-_]
;--3
.byte OT2,D1_4, OT1,C1_32,OT2,D1_32,OT1,C1_32,OT2,D1_32, OT1,L1_16,C1_16,L1_4	; Tr
.else	; OT up -------------------
.byte X1_2,X3_8,OT3,L1_16,C1_16			;
.byte OT4,D1_16,OT3,R1_16,C1_16,R1_16, L1_16,R1_16,SH1_16,R1_16, L1_16,D1_16,M1_16,D1_16, F1_16,OT2,L1_16,OT3,R1_16,OT2,L1_16				; [-_-_]
;--3
.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_4	; Tr
.endif
.byte JUMP
.word BGM_R_TEMP	; temp end
.endif	; End of Temp

.byte X1,X1,X1,X1

.byte X1,X1,X1
.byte X1_2,X3_8,OT2,RH1_16,X1_16

;--2
.byte M1_8,L1_16,X1_16,OT3,D1_16,X1_16,OT2,C1_8,L1_8,SH1_16,X1_16,C1_16,X1_16,TEMPO,$62,OT3,F1_8	; B ~ [H]
.byte TEMPO,$5E,M1_8,TEMPO,$5A,R1_8,TEMPO,$56,D1_8,TEMPO,$52,OT2,C1_8,TEMPO,$4E,OT3,D1_2
.byte TEMPO,$60,X1				; (B,95) [L]
.byte X1_2,X3_8,OT2,RH1_16,X1_16
...
.byte TEMPO,$60,X1				; (B,95) [L]
;.byte X1_2,X3_8,OT2,L1_16,C1_16
;.byte X1_2,X3_8,OT3,L1_16,C1_16			; OT up
.byte X1

;.byte OT3,D1_16,R1_16,OT2,C1_16,OT3,R1_16,OT2,L1_16,OT3,R1_16,OT2,SH1_16,OT3,R1_16, OT2,L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16
;.byte OT4,D1_16,R1_16,OT3,C1_16,OT4,R1_16,OT3,L1_16,OT4,R1_16,OT3,SH1_16,OT4,R1_16, OT3,L1_16,D1_16,M1_16,D1_16, F1_16,OT2,L1_16,OT3,R1_16,OT2,L1_16				; [-_-_] OT up
.byte X1
;--3
;.byte OT2,D1_4, OT1,C1_32,OT2,D1_32,OT1,C1_32,OT2,D1_32, OT1,L1_16,C1_16,L1_4,X1_8,OT2,RH1_8	; Tr
;.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_4,X1_8, RH1_8	; OT up
.byte X1
BGM_FF2_THE_MAGIC_HOUSE_CH0_S:
.byte M1_8,L1_16,X1_16,OT3,D1_16,X1_16,OT2,C1_8,L1_8,SH1_16,X1_16,C1_16,X1_16,TEMPO,$62,OT3,F1_8	; B ~ [H]
.byte TEMPO,$5E,M1_8,TEMPO,$5A,R1_8,TEMPO,$56,D1_8,TEMPO,$52,OT2,C1_8,TEMPO,$4E,OT3,D1_2
.byte TEMPO,$60,X1				; (B,95) [L]
.byte X1_2,X3_8,OT2,RH1_16,X1_16
...
;--4
;.byte D1_16,R1_16,OT2,C1_16,OT3,R1_16,OT2,L1_16,OT3,R1_16,OT2,SH1_16,OT3,R1_16, OT2,L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16
;.byte OT4,D1_16,R1_16,OT3,C1_16,OT4,R1_16,OT3,L1_16,OT4,R1_16,OT3,SH1_16,OT4,R1_16, OT3,L1_16,D1_16,M1_16,D1_16, F1_16,OT2,L1_16,OT3,R1_16,OT2,L1_16				; OT up
.byte X1
;.byte OT2,D1_4,OT1,C1_8,L1_16,C1_16,L1_4,X1_8,OT2,RH1_8	; Tr
;.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_4,X1_8, RH1_8		; OT up last oo
;.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_4,X1_4		; OT up
.byte X1

.if 0	; mute
;;;;.byte TEMPO,$64,X1,X1,X1			; (A,100)

;--5
;;;;.byte X1_2,X1_4,X1_8,OT2,L1_8
.else	; play as base
.byte TEMPO,$64
.byte M1_16,X1_16,X1_8,X1_8,D1_8,OT1,SH1_16,X1_16,X1_8,X1_8,L1_8
.byte C1_8,OT2,R1_8, D1_48,R1_48,D1_12, OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8	; ~

.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,SH1_16,X1_16

;--5
.byte F1_8,M1_8,OT2, D1_32,R1_32,D1_32,R1_32, D1_8, OT1,L1_8,X1_8,X1_8,OT2,L1_8		; Tr
.endif
.byte OT3,M1_16,X1_16,X1_8,X1_8,D1_8,OT2,SH1_16,X1_16,X1_8,X1_8,L1_8
.byte C1_8,OT3,R1_8, D1_48,R1_48,D1_12, OT2,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8	; ~

.byte OT3,M1_16,X1_16,X1_4,D1_8,OT2,SH1_16,X1_16,X1_4,SH1_16,X1_16
.byte F1_8,M1_8,OT3, D1_32,R1_32,D1_32,R1_32, D1_8, OT2,L1_8,X1_8,X1_8,RH1_8		; Tr

.byte JUMP
.word BGM_FF2_THE_MAGIC_HOUSE_CH0_S

BGM_FF2_THE_MAGIC_HOUSE_CH1:
.byte DUTY_1_2,$04,$00				; string
.byte VOL15
...
.if 1
.byte X1_2,X3_8,OT2,L1_16,C1_16			;
.byte OT3,D1_16,OT2,R1_16,C1_16,R1_16,L1_16,R1_16,SH1_16,R1_16, L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16				; [-_-_]
;--3
.byte OT2,D1_4, OT1,C1_32,OT2,D1_32,OT1,C1_32,OT2,D1_32, OT1,L1_16,C1_16,L1_4	; Tr
.else	; OT up
.byte X1_2,X3_8,OT3,L1_16,C1_16			;
.byte OT4,D1_16,R1_16,OT3,C1_16,OT4,R1_16,OT3,L1_16,OT4,R1_16,OT3,SH1_16,OT4,R1_16, OT3,L1_16,D1_16,M1_16,D1_16, F1_16,OT2,L1_16,OT3,R1_16,OT2,L1_16				; [-_-_]
;--3
.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_4	; Tr
.endif
.byte JUMP
.word BGM_R1_TEMP	; temp end
.endif	; End of Temp

.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,L1_8
.byte C1_8,OT2,R1_8, D1_48,R1_48,D1_12, OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8	; ~
.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,SH1_16,X1_16
.byte F1_8,M1_8,OT2, D1_32,R1_32,D1_32,R1_32, D1_8,OT1,L1_8,X1_4,L1_8			; Tr

.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,L1_8
.byte C1_8,OT2,R1_8, D1_48,R1_48,D1_12, OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8	; ~
.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,SH1_16,X1_16
.byte F1_8,M1_8,OT2, D1_32,R1_32,D1_32,R1_32, D1_8,OT1,L1_8,X3_8			; Tr

;--2
.byte X1					; string ? or change ? [H]
.byte OT3,X1_2,X3_8,M1_16,X1_16
.byte F1_48,S1_48,F1_12,M1_16,X1_16,L1_48,C1_48,L1_12,M1_16,X1_16,M1_48,F1_48,M1_12,R1_16,X1_16,X1_8,R1_16,X1_16	; ~ [L]
.byte M1_48,F1_48,M1_12,R1_16,X1_16,C1_48,OT4,D1_48,OT3,C1_12,R1_16,X1_16, R1_48,M1_48,R1_12,D1_16,X1_16,X1_4

.byte X1					; [H]
.byte OT3,X1_2,X3_8,M1_16,X1_16
.byte F1_48,S1_48,F1_12,M1_16,X1_16,L1_48,C1_48,L1_12,M1_16,X1_16,M1_48,F1_48,M1_12,R1_16,X1_16,X1_8,R1_16,X1_16	; ~ [L]

;;;; nylon string guitar start
.if 0
;;;;.byte M1_48,F1_48,M1_12,R1_16,X1_16,C1_48,OT4,D1_48,OT3,C1_12,R1_16,X1_16, R1_48,M1_48,R1_12,D1_16,X1_16, X1_8,OT2,L1_16,C1_16
;;;;.byte OT3,D1_16,OT2,R1_16,C1_16,R1_16, L1_16,R1_16,SH1_16,R1_16, L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16	; [-_-_]

;--3
;;;;.byte OT2,D1_4, OT1,C1_32,OT2,D1_32,OT1,C1_32,OT2,D1_32, OT1,L1_16,C1_16,L1_2	; Tr
.else
.if 0	; One more try as base
;;;;.byte M1_48,F1_48,M1_12,R1_16,X1_16,C1_48,OT4,D1_48,OT3,C1_12,R1_16,X1_16, R1_48,M1_48,R1_12,D1_16,X1_16, X1_4
;;;;.byte X1

;--3
;;;;.byte X1
.else	; Else of one more ...
.byte M1_48,F1_48,M1_12,R1_16,X1_16,C1_48,OT4,D1_48,OT3,C1_12,R1_16,X1_16, R1_48,M1_48,R1_12,D1_16,X1_16, DUTY_1_2,$03,$00,X1_8,OT3,L1_16,C1_16
.byte OT4,D1_16,OT3,R1_16,C1_16,R1_16, L1_16,R1_16,SH1_16,R1_16, L1_16,D1_16,M1_16,D1_16, F1_16,OT2,L1_16,OT3,R1_16,OT2,L1_16				; [-_-_]
;.byte OT2,D1_16,OT1,R1_16,C1_16,R1_16, L1_16,R1_16,SH1_16,R1_16, L1_16,D1_16,M1_16,D1_16, F1_16,OT0,L1_16,OT1,R1_16,OT0,L1_16	; [-_-_]

;--3
.byte OT3,D1_4, OT2,C1_32,OT3,D1_32,OT2,C1_32,OT3,D1_32, OT2,L1_16,C1_16,L1_2	; Tr
.byte DUTY_1_2,$04,$00
;.byte OT1,D1_4, OT0,C1_32,OT1,D1_32,OT0,C1_32,OT1,D1_32, OT0,L1_16,C1_16,L1_2	; Tr
.endif	; End of one more try
.endif
;;;; nylon string guitar start end
BGM_FF2_THE_MAGIC_HOUSE_CH1_S:
;.byte X1					; [H]
.byte OT2,M1_16,X1_16,X1_8,X1_8,M1_16,X1_16,M1_16,X1_16,X1_8,X1_8,F1_16,X1_16
;.byte OT3,X1_2,X3_8,M1_16,X1_16
.byte M1_8,F1_16,X1_16,FH1_16,X1_16,SH1_16,X1_16,L3_8,OT3,M1_16,X1_16
.byte F1_48,S1_48,F1_12,M1_16,X1_16,L1_48,C1_48,L1_12,M1_16,X1_16,M1_48,F1_48,M1_12,R1_16,X1_16,X1_8,R1_16,X1_16	; ~ [L]
.byte M1_48,F1_48,M1_12,R1_16,X1_16,C1_48,OT4,D1_48,OT3,C1_12,R1_16,X1_16, R1_48,M1_48,R1_12,D1_16,X1_16,X1_4
...
.byte OT2,X1_8,L1_16,C1_16,OT3,D1_4,OT2,X1_8,C1_16,OT3,D1_16,R1_4
.byte OT2,X1_8,C1_16,OT3,R1_16,M1_8,OT2,C1_8,OT3,M1_8,R1_32,M1_32,R1_16,D1_4
.byte OT2,X1_8,L1_16,C1_16,OT3,D1_4,OT2,X1_8,C1_16,OT3,D1_16,R1_8,D1_16,R1_16

;--5
.byte M1_16,RH1_16,M1_16,F1_16,M1_16,RH1_16,D1_16,OT2,C1_16,OT3,D1_16,M1_16,OT2,C1_16,OT3,M1_16,OT2,L1_4

.byte X1_8,L1_16,C1_16,OT3,D1_4,OT2,X1_8,C1_16,OT3,D1_16,R1_4
.byte OT2,X1_8,C1_16,OT3,R1_16,M1_8,OT2,C1_8,OT3,M1_8,R1_32,M1_32,R1_16,D1_4
.byte OT2,X1_8,L1_16,C1_16,OT3,D1_4,OT2,X1_8,C1_16,OT3,D1_16,R1_8,D1_16,R1_16
.byte M1_16,RH1_16,M1_16,F1_16,M1_16,RH1_16,D1_16,OT2,C1_16,OT3,D1_16,M1_16,OT2,C1_16,OT3,M1_16,OT2,L1_4

.byte JUMP
.word BGM_FF2_THE_MAGIC_HOUSE_CH1_S


.if 0	; Deprecated CH0
.byte L1_4,X1_8,C1_8,OT2,D1_4,X1_8,R1_8

.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
.byte R1_4,OT1,L1_4,OT2,M1_4,X1_4
.byte M1_4,OT1,SH1_4,L1_4,X1_4
;;;
.byte L1_4,X1_8,C1_8,OT2,D1_4,X1_8,R1_8
.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
.byte R1_4,OT1,L1_4,OT2,M1_4,X1_4
...
.byte M1_4,OT1,SH1_4,L1_4,X1_4
BGM_FF2_THE_MAGIC_HOUSE_CH1_R1:
.byte L1_4,X1_8,C1_8,OT2,D1_4,X1_8,R1_8
.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
...
.byte M1_4,OT1,SH1_4,L1_4,X1_4
;;;
.byte OT2,R1_4,M1_4,L1_8,OT1,L1_8,C1_8,OT2,R1_8
.byte M1_4,OT1,SH1_4,L1_4,X1_8,L1_8

.byte OT2,M1_4,X1_8,D1_8,OT1,SH1_4,X1_8,L1_8
.byte C1_8,OT2,R1_8,D1_8,OT1,C1_8,SH1_8,L1_8,L1_8,L1_8

.byte OT2,M1_4,X1_8,D1_8,OT1,SH1_4,X1_8,SH1_8
.byte F1_8,M1_8,OT2,D1_4,OT1,L1_4,X1_8,L1_8

.byte OT2,M1_4,X1_8,D1_8,OT1,SH1_4,X1_8,L1_8
.byte C1_8,OT2,R1_8,D1_8,OT1,C1_8,SH1_8,L1_8,L1_8,L1_8

.byte OT2,M1_4,X1_8,D1_8,OT1,SH1_4,X1_8,SH1_8
.byte F1_8,M1_8,OT2,D1_4,OT1,L1_4,X1_4

.byte OT1	;
.endif	; End of deprecated
.if 0	; Deprecated CH1
.byte DUTY_1_2,$04,$00				; keep
.byte M1_8					; keep
.byte F1_8,M1_8,L1_8,M1_8,M1_8,R1_8,X1_8,R1_8
.byte M1_8,R1_8,C1_8,R1_8,R1_8,D1_8,X1_8
.byte DUTY_1_4,$04,$04				; keep
.byte OT2,RH1_8					; keep
;;;
.byte M1_8,L1_8,OT3,D1_8,OT2,C1_8,L1_8,SH1_8,C1_8,OT3,F1_8
.byte M1_8,R1_8,D1_8,OT2,C1_8,OT3,D3_8,M1_8
.byte F1_8,M1_8,L1_8,M1_8,M1_8,R1_8,X1_8,R1_8

.byte M1_8,R1_8,C1_8,R1_8,R1_8,D1_8,X1_8,OT2,L1_16,C1_16
.byte OT3,D1_16,R1_16,OT2,C1_16,OT3,R1_16,OT2,L1_16,OT3,R1_16,OT2,SH1_16,OT3,R1_16, OT2,L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16

.byte OT2,D1_4,OT1,C1_8,L1_16,C1_16,L1_4,X1_8,OT2,RH1_8
BGM_FF2_THE_MAGIC_HOUSE_CH0_R1:
.byte M1_8,L1_8,OT3,D1_8,OT2,C1_8,L1_8,SH1_8,C1_8,OT3,F1_8
.byte M1_8,R1_8,D1_8,OT2,C1_8,OT3,D3_8,M1_8

.byte F1_8,M1_8,L1_8,M1_8,M1_8,R1_8,X1_8,R1_8
.byte M1_8,R1_8,C1_8,R1_8,R1_8,D1_8,X1_8,OT2,RH1_8
.byte M1_8,L1_8,OT3,D1_8,OT2,C1_8,L1_8,SH1_8,C1_8,OT3,F1_8
...
;;;
.byte OT3,D1_16,R1_16,OT2,C1_16,OT3,R1_16, OT2,L1_16,OT3,R1_16,OT2,SH1_16,OT3,R1_16, OT2,L1_16,D1_16,M1_16,D1_16, F1_16,OT1,L1_16,OT2,R1_16,OT1,L1_16
.byte OT2,D1_4,OT1,C1_8,L1_16,C1_16,L1_4,X1_4

.byte TEMPO,$64					; A

.byte X1_8,OT2,L1_16,C1_16,OT3,D1_4,X1_8,OT2,C1_16,OT3,D1_16,R1_4
.byte X1_8,OT2,C1_16,OT3,R1_16,M1_8,OT2,C1_8,OT3,M1_8,R1_8,D1_4

.byte X1_8,OT2,L1_16,C1_16,OT3,D1_4,X1_8,OT2,C1_16,OT3,D1_16,R1_8,D1_16,R1_16
.byte M1_16,RH1_16,M1_16,F1_16, M1_16,R1_16,D1_16,OT2,C1_16, OT3,D1_16,M1_16,OT2,C1_16,OT3,M1_16, OT2,L1_4

.byte X1_8,L1_16,C1_16,OT3,D1_4,X1_8,OT2,C1_16,OT3,D1_16,R1_4
.byte X1_8,OT2,C1_16,OT3,R1_16,M1_8,OT2,C1_8,OT3,M1_8,R1_8,D1_4

.byte X1_8,OT2,L1_16,C1_16,OT3,D1_4,X1_8,OT2,C1_16,OT3,D1_16,R1_8,D1_16,R1_16
.byte M1_16,RH1_16,M1_16,F1_16, M1_16,R1_16,D1_16,OT2,C1_16, OT3,D1_16,M1_16,OT2,C1_16,OT3,M1_16, OT2,L1_8,RH1_8
...
.byte C1_8,OT2,R1_8, D1_48,R1_48,D1_12, OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8
.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,SH1_16,X1_16
.byte F1_8,M1_8,OT2, D1_32,R1_32,D1_32,R1_32, D1_8,OT1,L1_8,X1_4,L1_8

.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,L1_8
.byte C1_8,OT2,R1_8, D1_48,R1_48,D1_12, OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8
.byte OT2,M1_16,X1_16,X1_4,D1_8,OT1,SH1_16,X1_16,X1_4,SH1_16,X1_16
.byte F1_8,M1_8,OT2, D1_32,R1_32,D1_32,R1_32, D1_8,OT1,L1_8,X3_8

;--2
.byte L1_4,X1_8,C1_16,X1_16,OT2,D1_4,X1_8,R1_16,X1_16		; [H]
.byte M1_8,F1_16,X1_16,FH1_16,X1_16,S1_16,X1_16,L1_2
.byte R1_16,X1_16,X1_8,OT1,L1_16,X1_16,X1_8,OT2,M1_4,X1_4	; [L]
.byte M1_16,X1_16,X1_8,OT1,SH1_16,X1_16,X1_8,L3_8,OT2,RH1_8

.byte OT1,L1_4,X1_8,C1_16,X1_16,OT2,D1_4,X1_8,R1_16,X1_16	; [H]
.byte M1_8,F1_16,X1_16,FH1_16,X1_16,SH1_16,X1_16,L1_2
.byte R1_16,X1_16,X1_8,OT1,L1_16,X1_16,X1_8,OT2,M1_4,X1_4	; [L]
.byte M1_16,X1_16,X1_8,OT1,SH1_16,X1_16,X1_8,L1_4,X1_4

.byte OT2,R1_4,M1_4,L1_8,OT1,L1_8,C1_8,OT2,R1_8			; [-_-_]
;--3
.byte M1_4,OT1,SH1_4,L1_2
BGM_FF2_THE_MAGIC_HOUSE_TRI_S:
.byte L1_4,X1_8,C1_16,X1_16,OT2,D1_4,X1_8,R1_16,X1_16		; [H]
.byte M1_8,F1_16,X1_16,FH1_16,X1_16,SH1_16,X1_16,L1_2
.byte R1_16,X1_16,X1_8,OT1,L1_16,X1_16,X1_8,OT2,M1_4,X1_4	; [L]
.byte M1_16,X1_16,X1_8,OT1,SH1_16,X1_16,X1_8,L3_8,OT2,RH1_8
...
;--4
.byte OT2,R1_4,M1_4,L1_8,OT1,L1_8,C1_8,OT2,R1_8			; [-_-_]
.byte M1_4,OT1,SH1_4,L3_8,L1_8
.byte OT2,M1_16,X1_16,X1_8,X1_8,D1_8,OT1,SH1_16,X1_16,X1_8,X1_8,L1_8	; (A,100)
.byte C1_8,OT2,R1_8,D1_8,OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8
.byte OT2,M1_16,X1_16,X1_8,X1_8,D1_8,OT1,SH1_16,X1_16,X1_8,X1_8,SH1_16,X1_16

;--5
.byte F1_8,M1_8,OT2,D1_4,OT1,L1_8,X1_8,X1_8,L1_8
.byte OT2,M1_16,X1_16,X1_8,X1_8,D1_8,OT1,SH1_16,X1_16,X1_8,X1_8,L1_8
.byte C1_8,OT2,R1_8,D1_8,OT1,C1_8,SH1_8,L1_16,X1_16,L1_16,X1_16,L1_8
.byte OT2,M1_16,X1_16,X1_8,X1_8,D1_8,OT1,SH1_16,X1_16,X1_8,X1_8,SH1_16,X1_16
.byte F1_8,M1_8,OT2,D1_4,OT1,L1_8,X1_8,X1_4

.byte JUMP
.word BGM_FF2_THE_MAGIC_HOUSE_TRI_S


.if 0	; Monotic version
.byte OT3,M1_4,X1_8,D1_8,OT2,SH1_4,X1_8,L1_8
.byte C1_8,OT3,R1_8,D1_8,OT2,C1_8,SH1_8,L1_8,L1_8,L1_8
.byte OT3,M1_4,X1_8,D1_8,OT2,SH1_4,X1_8,SH1_8

.byte F1_8,M1_8,OT3,D1_4,OT2,L1_4,X1_8,L1_8
.byte OT3,M1_4,X1_8,D1_8,OT2,SH1_4,X1_8,L1_8
.byte C1_8,OT3,R1_8,D1_8,OT2,C1_8,SH1_8,L1_8,L1_8,L1_8

.byte OT3,M1_4,X1_8,D1_8,OT2,SH1_4,X1_8,SH1_8
.byte F1_8,M1_8,OT3,D1_4,OT2,L1_4,X1_4
.byte L1_4,X1_8,C1_8,OT3,D1_4,X1_8,R1_8

.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
.byte R1_4,OT2,L1_4,OT3,M1_4,X1_4
.byte M1_4,OT2,SH1_4,L1_4,X1_4
;;;
.byte L1_4,X1_8,C1_8,OT3,D1_4,X1_8,R1_8
.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
.byte R1_4,OT2,L1_4,OT3,M1_4,X1_4
...
.byte M1_4,OT2,SH1_4,L1_4,X1_4
BGM_FF2_THE_MAGIC_HOUSE_TRI_R1:
.byte L1_4,X1_8,C1_8,OT3,D1_4,X1_8,R1_8
.byte M1_8,F1_8,FH1_8,SH1_8,L1_4,X1_4
...
.byte M1_4,OT2,SH1_4,L1_4,X1_4
;;;
.byte OT3,R1_4,M1_4,L1_8,OT2,L1_8,C1_8,OT3,R1_8
.byte M1_4,OT2,SH1_4,L1_4,X1_8,L1_8
...
.byte JUMP
.word BGM_FF2_THE_MAGIC_HOUSE_TRI_R1
.endif	; End of Monotic version

BGM_FF2_THE_MAGIC_HOUSE_NOI:
.byte X1_16				; CB
BGM_FF2_THE_MAGIC_HOUSE_NOI_S:
.byte $F9				; F9 = hi-hat preset
.byte D1_4,D1_4,D1_4,D1_4		; 05 05 05 05
.byte X1_2
.byte $FA				; FA = snare drum preset
.byte D1_4,D1_4,D1_4,D1_4		; 05 05 05 05
.byte X1_2
.byte $F9				; F9 = hi-hat preset
.byte D1_2,D1_2				; 05 05 05 05
.byte X1_2
.byte $FA				; FA = snare drum preset
.byte D1_2,D1_2				; 05 05 05 05
.byte X1_2
...
.byte JUMP		; FE 62 BF 
.word BGM_FF2_THE_MAGIC_HOUSE_NOI_S
...
.byte OT0		; EF
.byte VOL13		; $B9C0	ED
.byte L1_4,L1_4		; 95 95
.byte $F9		; F9 = hi-hat preset
.byte D1_4		; 05
.byte DUTY_1_8,$01,$FF	; F5 01 FF
.byte OT0		; EF
.byte VOL13		; ED
.byte L1_4,L1_2		; 95 92
.byte $F9		; F9 = hi-hat preset
.byte D1_2		; 02
.byte DUTY_1_8,$01,$FF	; F5 01 FF
.byte OT0		; $B9D1	EF
.byte VOL13		; ED
.byte L1_4,L1_4,L1_24	; 95 95 9C
.byte VOL12		; EC
.byte L1_24		; 9C
.byte VOL11		; EB
.byte L1_24		; 9C
...
.byte BACK_CNT,$02	; FB 02 
M_B717_NOI_BA00:
.byte $F9		; $BA00 F9 = hi-hat preset
.byte D1_4		; 05
.byte DUTY_1_8,$01,$FF	; F5 01 FF
.byte OT0		; EF
.byte VOL13		; ED
.byte L1_4		; 95
.byte BACK_N		; FC 00 BA
.word M_B717_NOI_BA00
.byte BACK_CNT,$02	; FB 02 
M_B717_NOI_BA0D:
.byte $F9		; F9 = hi-hat preset
.byte D1_4		; 05
.byte $FA		; FA = snare drum preset
.byte D1_4		; $BA10 05
.byte BACK_N		; FC 0D BA
.word M_B717_NOI_BA0D
.byte BACK_CNT,$08	; FB 08
M_B717_NOI_BA16:
.byte $F9		; F9 = hi-hat preset
.byte D1_4		; 05
.byte $FA		; FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_4,D1_8		; 05 08
.byte $FA		; FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_8		; $BA20	08
.byte BACK_N		; FC 16 BA
.word M_B717_NOI_BA16
.byte BACK_CNT,$02	; FB 02
M_B717_NOI_BA26:
.byte $F9		; F9 = hi-hat preset
.byte D1_4,D1_8		; 05 08
...
.byte D1_4		; 05
.byte $F9		; F9 = hi-hat preset
.byte D1_8,D1_8		; 08 08
.byte $FA		; FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_8,D1_8		; 08 08 
.byte $FA		; $BA40	FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_8,D1_8		; 08 08
.byte JUMP_Z		; FD 5C BA
.word M_B717_NOI_BA5C
.byte $FA		; FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_8		; 08
...
.byte $F9		; F9 = hi-hat preset
.byte D1_8		; 08 
.byte $FA		; $BA50	FA = snare drum preset
.byte D1_8		; 08
.byte $F9		; F9 = hi-hat preset
.byte D1_8		; 08
.byte $FA		; FA = snare drum preset
...
.byte $F9		; F9 = hi-hat preset
.byte D1_8		; 08
.byte BACK_N		; FC 26 BA
.word M_B717_NOI_BA26
M_B717_NOI_BA5C:
.byte D1_4,D1_4,D1_8	; 05 05 08
.byte $FA		; FA = snare drum preset
.byte D1_8,D1_8,D1_8	; $BA60	08 08 08
.byte JUMP		; FE BA B9 
.word M_B717_NOI_B9BA
...
F6 02 FF
EB FB
02 C8 F2 38 4B CB 0B CB F1 9B CB 8B CB 9B 
...
91 D8 9B AB 92 72 90 80 FE CD BC 
...
2B 4D DE F1 2F FE 93 BD 

;$BE98
M_BCC0_TRI:
CB FB 20 F0 9B CB FC 9B 
...
;----------
;8D1A - $2D = Chocobos!(No Melody) -> Bullied Prince ??
...
;----------
;8DA2 - $2E = Let's Play the Piano Again! -> Salonia ??
...
;----------
;8F76 - $2F = The Everlasting World (Ending Part 3) -> The Boundless Ocean ??
...
;----------
;9128 - $30 = The Everlasting World (Ending Part 1) -> fall ??
M_9128:
.word M_9128_CH0			; 32 91
.word M_9128_CH1			; 3B 91
.byte $FF,$FF				; FF FF
.word M_9128_NOI			; 40 91
.byte $FF,$FF				; FF FF 
M_9128_CH0:				; $9132
.byte DUTY_1_4,$1A,$FF			; F6 1A FF
.byte $F8,$C4				; F8 C4	- sweep
.byte OT5				; F4
.byte L1				; 90
.byte A1_4				; D5
.byte $FF				; FF 
...
;----------
;9148 - $31 = Bad Event -> Take off invinsible ??
M_9148:
.word M_9148_CH0			; 52 91
.word M_9148_CH1			; 6B 91
.word M_9148_TRI			; 82 91 
.word M_9148_NOI			; 8C 91
.byte $FF,$FF				; FF FF 
M_9148_CH0:				; $9152
F5 19 FF F8 8F F2 E6 04 E7 04 E8 04 E9 04
EA 04 EB 04 EC 04 ED 04 EE 04 FF 
M_9148_CH1:				; $916B
F5 19 FF F8 8F
...
14 FF 
M_9148_TRI:				; $9182
F4 C2 04 C2 0B C7 02 C2 04 FF 
M_9148_NOI:				; $918C
.byte DUTY_1_8,$16,$FF			; F5 16 FF
.byte OT1				; F0
.byte R1,DH1,D1				; 20 10 00
.byte OT0				; EF
.byte F1_4,L1_2				; 55 92
.byte DUTY_1_8,$0B,$FF			; F5 0B FF
.byte L1,A1				; 90 D0
.byte $FF				; FF

;----------
;919C - $32 = This is the Last Battle -> Upgrade machine ??
M_919C:
.word M_919C_CH0			; A6 91
.word M_919C_CH1			; B4 91
.byte $FF,$FF				; FF FF 
.word M_919C_NOI			; B9 91
.word $FF,$FF				; FF FF 
M_919C_CH0:				; $91A6
...
CC E7 FE A6 91 
M_919C_NOI:				; $91B9
.byte DUTY_1_8,$15,$FF			; F5 15 FF
.byte OT0				; EF
.byte C1_4,L1_4,S1_4			; B5 95 75
.byte LH1_4,SH1_4			; $91C0	A5 85
.byte $FF				; FF

;----------
;91C3 - $33 = This is the Last Battle 2(x2) -> Cheers
M_91C3:
.word M_91C3_CH0			; CD 91
.word M_91C3_CH1			; DA 91
.word M_91C3_TRI			; E5 91
.word M_91C3_NOI			; F0 91
.byte $FF,$FF				; FF FF 
M_91C3_CH0:				; $91CD
F6 1E 0C
F4 CE 58 C9 53 CE 58 C9 53 FF 
M_91C3_CH1:				; $91DA
F6 1E 0C F3 EB 13
DB C5 13 DB FF 
M_91C3_TRI:				; $91E5
F5 FF 0C F4 CC 25 24 CC 25 24 FF
M_91C3_NOI:				; $91F0
.byte DUTY_1_8,$14,$FF			; F5 14 FF
.byte OT0				; EF
.byte BACK_CNT,$02			; FB 02 
M_91C3_NOI_91F6:
.byte SH3_32,SH3_32,FH3_32,FH3_32,M3_32,LH3_32,L3_32	; 89 89 69 69 49 A9 99
.byte BACK_N				; FC F6 91
.word M_91C3_NOI_91F6
.byte $FF				; $9200 FF

;----------
;9201 - $34 = Let's Play the Piano! -> woo ??
0B 92 15 92 FF FF FF FF FF FF 
F7 1C FF F8 B5
F2 54 43 32 FF F7 1C FF F8 B5 F1 14 03 F0 B2 FF

;----------
;9220 - $35 = Leaving Party -> Bahamute wings ??
M_9220:
...
M_9220_NOI:				; $923D
.byte VOL11				; EA
.byte DUTY_1_8,$1A,$FF			; F5 1A FF
M_9220_NOI_9241:
.byte OT1				; $9241 F0
.byte D1_16				; 0B
.byte OT0				; EF
.byte FH1_32,R1_12,X1_8			; 6D 2A C8
.byte JUMP				; FE 41 92
.word M_9220_NOI_9241

;----------
;924A - $36 = Joining Party -> Crystal Room ??
...
;$37-$3A
B3B6	;B6 B3 - $37 = Bullied Prince -> The Everlasting World (Ending Part 2)
B876	;76 B8 - $38 = Salonia -> Castle of Hain
BA82	;82 BA - $39 = The Boundless Ocean -> Chocobos!(No Melody)
BABF	;BF BA - $3A = Fall -> Let's Play the Piano Again!

;----------
;B3B6 - $37 = Bullied Prince -> The Everlasting World (Ending Part 2) ??
...
;----------
;B876 - $38 = Salonia -> Castle of Hain ??
...
;----------
;BA82 - $39 = The Boundless Ocean -> Chocobos!(No Melody) ??
...
;----------
;BABF - $3A = Fall -> Let's Play the Piano Again! ??
...
;$3B-$40
B40C	;0C B4 - $3B = Take off invinsible
BCC7	;C7 BC - $3C = Upgrade machine
...
;----------
;$B40C - $3B = Take off invinsible -> The Everlasting World (Ending Part 3) ??
M_B40C:
.word M_B40C_CH0			; 16 B4
.word M_B40C_CH1			; 7D B5
.word M_B40C_TRI			; 91 B9
.word M_B40C_NOI			; 7A BB
.byte $FF,$FF				; FF FF 
M_B40C_CH0:				; $B416
...
55 EC F2 70 E0 50 62 E0 4B 42 60 D0 FF 
M_B40C_CH1:				; $B57D
F6 0B 07
...
FF 
M_B40C_TRI:				; $B991
FB 0C C0 FC 93 B9 FB 03 F1 FB 02 C8 2B CB 68
...
;----------
;BCC7 - $3C = Upgrade machine -> The Everlasting World (Ending Part 1) ??
...
;----------
;BF14 - $3E = woo -> This is the Last Battle
M_BF14:
.word M_BF14_CH0			; 1E BF
.word M_BF14_CH1			; 69 BF
.word M_BF14_TRI			; 71 BF
.byte $FF,$FF,$FF,$FF			; FF FF FF FF 
M_BF14_CH0:				; $BF1E
.byte TEMPO,$46				; E0 46
M_BF14_CH0_BF20:
F7 04 06 EB 
M_BF14_CH0_BF24:
F3 0A 1A 3A F2 6A 7A 9A 0A 1A 3A F1
...
M_BF14_TRI:				; $BF71
M_BF14_TRI_BF71:
F1 02 37 6A 9A 7A 6A 02 37 6A 9A 7A 6A F0 B5

D7 F1 2A 55 AF BF DE DC AF BF DE DC AF BF DE DC
F0 B5 D7 F1 2A 55 AF BF DE DC AF BF DE DC AF BF
DE DC
.byte JUMP				; FE 71 BF
.word M_BF14_TRI_BF71

;----------
;BFA5 - $3F = Bahamute wings -> This is the Last Battle 2(x2)
M_BFA5:
.word M_BFA5_CH0			; AF BF
.word M_BF14_CH1			; 69 BF
.word M_BF14_TRI			; 71 BF
.byte $FF,$FF,$FF,$FF			; FF FF FF FF 
M_BFA5_CH0:
.byte TEMPO,$78				; $AFBF	E0 78
.byte JUMP				; FE 20 BF
.word M_BF14_CH0_BF20

;----------
;BFB4 - $40 = Crystal Room -> Let's Play the Piano! ??
...
VolEnvTbl:
.word VE_9ACE	;CE 9A - $00
.word VE_9ADB	;DB 9A - $01
.word VE_9AED	;ED 9A - $02
.word VE_9B0E	;0E 9B - $03
.word VE_9B55	;55 9B - $04
.word VE_9B83	;83 9B - $05
.word VE_9BA0	;A0 9B - $06
.word VE_9BAA	;AA 9B - $07
.word VE_9BC9	;C9 9B - $08
.word VE_9BE8	;E8 9B - $09
.word VE_9C0A	;0A 9C - $0A
.word VE_9B18	;18 9B - $0B
.word VE_9B73	;73 9B - $0C
.word VE_9B22	;22 9B - $0D
.word VE_9B7B	;7B 9B - $0E
.word VE_9C24	;24 9C - $0F
.word VE_9C40	;40 9C - $10
.word VE_9C00	;00 9C - $11
.word VE_9C56	;56 9C - $12
.word VE_9C72	;72 9C - $13
.word VE_9C82	;82 9C - $14
.word VE_9C91	;91 9C - $15
.word VE_9C9B	;9B 9C - $16
.word VE_9CA5	;A5 9C - $17
.word VE_9D3A	;3A 9D - $18
.word VE_9DC5	;C5 9D - $19
.word VE_9E23	;23 9E - $1A
.word VE_9E40	;40 9E - $1B
.word VE_9CD7	;D7 9C - $1C
.word VE_9C4A	;4A 9C - $1D
.word VE_9E51	;51 9E - $1E
.word VE_9D80	;80 9D - $1F
.word VE_9CF3	;F3 9C - $20
.word VE_9D16	;16 9D - $21
.word VE_9CBF	;BF 9C - $22
.word VE_9CEB	;EB 9C - $23
.word VE_9DF4	;F4 9D - $24
.word VE_9E6F	;6F 9E - $25
.word VE_9E31	;31 9E - $26
.word VE_9B28	;28 9B - $27
...
;		  3rd : + = vol up, - = vol down(if 2nd is not terminate(0) ) - 2nd, 3rd repeat <- temporary value, not permanent
...
.word VE_9AEB				; EB 9A
VE_9AE1:
.byte $0F,$0C,$09,$07,$05,$03,$02,$01,$00,$FF
VE_9AEB:
.byte $00,$00
...
.word VE_9B0C				; 0C 9B
VE_9AF3:
.byte $0F,$0F,$0E,$0E,$0D,$0D,$0C,$0C,$0B,$0B,$0A,$0A,$09,$09,$08,$08,$08,$07,$07,$07,$07,$06,$FF
VE_9B0A:
.byte $14,$00
VE_9B0C:
.byte $1E,$00
...
.word VE_9B53				; 53 9B
VE_9B2E:
.byte $0F,$0F,$0E,$0E,$0D,$0D,$0C,$0C,$0B,$0B,$0A,$0A,$09,$09,$08,$08,$08,$07,$07,$07,$06,$06,$06,$06,$05,$05,$05,$05,$05,$04,$04,$04,$04,$04,$04,$03,$FF
VE_9B53:
.byte $05,$00
...
.word VE_9B71				; 71 9B
VE_9B5B:
.byte $05,$06,$07,$08,$09,$09,$0A,$0A,$0B,$0B,$0C,$0C,$0D,$0D,$0F,$FF
VE_9B6B:
.byte $05,$02,$00,$02,$FF,$FC
VE_9B71:
.byte $32,$00
...
.word VE_9B9E				; 9E 9B
VE_9B89:
.byte $0B,$0C,$0D,$0E,$0F,$0E,$0D,$0C,$0B,$0A,$09,$08,$07,$07,$06,$06,$06,$05,$FF
VE_9B9C:
.byte $0A,$00
VE_9B9E:
.byte $05,$00
...
.word VE_9BC7				; C7 9B
VE_9BB0:
.byte $0F,$06,$08,$09,$0A,$0B,$0C,$0D,$0E,$0F,$FF
VE_9BBB:
.byte $05,$01,$00,$02,$FF,$02,$FE,$02,$FF,$01,$00,$F6
VE_9BC7:
.byte $43,$00
...
.word VE_9BE6				; E6 9B
VE_9BCF:
.byte $05,$06,$07,$08,$09,$09,$0A,$0A,$0B,$0B,$0D,$0D,$0F,$0F,$FF
VE_9BDE:
.byte $05,$01,$00,$02,$FF,$01,$00,$FA
VE_9BE6:
.byte $32,$00
...
.word VE_9BFE				; FE 9B
VE_9BEE:
.byte $0F,$0E,$0D,$0C,$0B,$0A,$09,$08,$08,$07,$07,$07,$06,$FF
VE_9BFC:
.byte $19,$00
VE_9BFE:
.byte $1E,$00
...
.word VE_9C1C				; 1C 9C
VE_9C10:
.byte $07,$09,$0B,$0D,$0F,$FF
VE_9C16:
.byte $05,$02,$00,$02,$FF,$FC
VE_9C1C:
.byte $32,$02,$00,$02,$FE,$02,$01,$FA
...
.word VE_9C3E				; 3E 9C
VE_9C2A:
.byte $03,$03,$05,$05,$07,$07,$09,$09,$0B,$0B,$0D,$0D,$0F,$FF
VE_9C38:
.byte $05,$02,$00,$02,$FF,$FC
VE_9C3E:
.byte $1E,$00
...
.word VE_9C70				; 70 9C
VE_9C5C:
.byte $0F,$0F,$0E,$0E,$0D,$0D,$0C,$FF
VE_9C64:
.byte $00,$01,$00,$02,$FF,$02,$FE,$02,$FF,$01,$00,$F6
VE_9C70:
.byte $32,$00
...
.word VE_9CBD				; BD 9C 
VE_9CAB:
.byte $01,$02,$03,$04,$05,$06,$07,$08,$09,$0A,$0B,$0C,$0D,$0E,$0F,$FF
VE_9CBB:
.byte $00,$00
VE_9CBD:
.byte $64,$00
...
.word VE_9CD5				; D5 9C
VE_9CC5:
.byte $08,$00,$09,$00,$0A,$00,$0B,$00,$0C,$00,$0D,$00,$0E,$00,$0F,$FF
VE_9CD5:
.byte $64,$00
...
.word VE_9CBD				; BD 9C
VE_9CDD:
.byte $00,$01,$FD,$01,$FA,$01,$F7,$01,$FA,$01,$FD,$01,$00,$F4
...
.word VE_9D10				; 10 9D
VE_9CF9:
.byte $00,$02,$00,$04,$00,$06,$00,$08,$00,$0A,$00,$0C,$00,$0E,$00,$0F,$FF
VE_9D0A:
.byte $00,$01,$F1,$01,$00,$FC
VE_9D10:
.byte $64,$01,$F1,$01,$00,$FC
...
.word VE_9D34				; 34 9D
VE_9D1C:
.byte $01,$00,$03,$00,$05,$00,$07,$00,$09,$00,$0B,$00,$0D,$00,$0F,$FF
VE_9D2C:
.byte $00,$01,$F1,$01,$F1,$01,$00,$FC
VE_9D34:
.byte $64,$01,$F1,$01,$00,$FC
...
.word VE_9D7E				; 7E 9D
VE_9D40:
.byte $01,$01,$01,$01,$02,$02,$02,$02,$03,$03,$03,$03,$04,$04,$04,$04,$05,$05,$05,$05,$06,$06,$06,$06,$07,$07,$07,$07,$08,$08,$08,$08,$09,$09,$09,$09,$0A,$0A,$0A,$0A,$0B,$0B,$0B,$0B,$0C,$0C,$0C,$0C,$0D,$0D,$0D,$0D,$0E,$0E,$0E,$0E,$0F,$0F,$0F,$0F,$00,$FF
VE_9D7E:
.byte $00,$00
...
.word VE_9DC3				; C3 9D
VE_9D86:
.byte $01,$00,$01,$00,$02,$00,$02,$00,$03,$00,$03,$00,$04,$00,$04,$00,$05,$00,$05,$00,$06,$00,$06,$00,$07,$00,$07,$00,$08,$00,$08,$00,$09,$00,$09,$00,$0A,$00,$0A,$00,$0B,$00,$0B,$00,$0C,$00,$0C,$00,$0D,$00,$0D,$00,$0E,$00,$0E,$00,$0F,$00,$0F,$00,$FF
VE_9DC3:
.byte $00,$00
...
.word VE_9DF2				; F2 9D
VE_9DCB:
.byte $01,$03,$05,$07,$07,$07,$07,$07,$07,$07,$07,$09,$0B,$0D,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0F,$0D,$0B,$09,$07,$07,$07,$07,$07,$07,$07,$07,$05,$03,$01,$00,$FF
VE_9DF2:
.byte $00,$00
...
.word VE_9E21				; 21 9E
VE_9DFA:
.byte $01,$00,$05,$00,$07,$00,$07,$00,$07,$00,$07,$00,$0B,$00,$0F,$00,$0F,$00,$0F,$00,$0F,$00,$0F,$00,$0B,$00,$07,$00,$07,$00,$07,$00,$07,$00,$05,$00,$01,$00,$FF
VE_9E21:
.byte $00,$00
...
.word VE_9E4F				; 4F 9E
VE_9E46:
.byte $0F,$0F,$03,$03,$06,$09,$0C,$0F,$FF
VE_9E4F:
.byte $21,$00
...
.byte $03,$06,$09,$0C,$0F,$FF
VE_9E5D:
.byte $00,$01,$FE,$01,$FC,$01,$FA,$01,$FC,$01,$FE,$01,$00
VE_9E6B:
.byte $F4,$64,$01,$FF,$FE
...
.word VE_9EA9				; A9 9E 
VE_9E83:
.byte $07,$07,$09,$0B,$0D,$0F,$0F,$0F,$0F,$0A,$05,$0A,$0F,$0A,$05,$00,$05,$0A,$0F,$0A,$05,$00,$00,$05,$0A,$0F,$0A,$05,$00,$00,$00,$05,$0A,$0F,$0A,$05,$00,$FF
VE_9EA9:
.byte $00,$00
;9EAA
;----------
...
.if 0
.byte $1B
.byte $01,$FF,$03,$00, $01,$FF,$03,$00, $01,$FF,$03,$00
.byte $01,$FF,$04,$00, $01,$FF,$04,$00, $01,$FF,$04,$00
.byte $01,$FF,$05,$00, $01,$FF,$05,$00, $01,$FF,$05,$00
.byte $01,$FF,$06,$00, $01,$FF,$06,$00, $01,$FF,$06,$00
.byte $01,$00,$00,$00
.else
.if 0	; A
.byte $16
.byte $01,$FF,$07,$00, $01,$FF,$07,$00, $01,$FF,$07,$00
.byte $01,$FF,$09,$00, $01,$FF,$09,$00, $01,$FF,$09,$00
.byte $01,$FF,$0B,$00, $01,$FF,$0B,$00, $01,$FF,$0B,$00
.byte $01,$FF,$0D,$00, $01,$FF,$0D,$00, $01,$FF,$0D,$00
.byte $01,$00,$00,$00
.else	; Else of A
.byte $00
...
PitEnvTbl:
.word PE_9ECB	;CB 9E - $00
.word PE_9ED0	;D0 9E - $01
.word PE_9ED7	;D7 9E - $02
.word PE_9EDE	;DE 9E - $03
.word PE_9EE3	;E3 9E - $04
.word PE_9EE6	;E6 9E - $05
.word PE_9EED	;ED 9E - $06
.word PE_9EF4	;F4 9E - $07
.word PE_9EFB	;FB 9E - $08
.word PE_9EFE	;FE 9E - $09
.word PE_9F05	;05 9F - $0A
.word PE_9F24	;24 9F - $0B
.word PE_9F2F	;2F 9F - $0C
.word PE_9F7A	;7A 9F - $0D
.word PE_9F8D	;8D 9F - $0E
.word PE_9FA2	;A2 9F - $0F
.word PE_NEW1	; - $10
.word PE_NEW2	; - $11
.word PE_NEW3	; - $12
.word PE_NEW4	; - $13
...
.byte $04,$FF,$04,$01,$FC
PE_9ED0:					; $9ED0 - $01
.byte $32,$00,$06,$FF,$06,$01,$FC
PE_9ED7:					; $9ED7 - $02
.byte $32,$FF,$06,$01,$06,$FF,$FC
PE_9EDE:					; $9EDE - $03
.byte $06,$FF,$06,$01,$FC
PE_9EE3:					; $9EE3 - $04
.byte $01,$FF,$00
PE_9EE6:					; $9EE6 - $05
.byte $10,$00,$06,$FF,$06,$01,$FC
PE_9EED:					; $9EED - $06
.byte $06,$00,$06,$FF,$06,$01,$FC
PE_9EF4:					; $9EF4 - $07
.byte $18,$00,$06,$FF,$06,$01,$FC
PE_9EFB:					; $9EFB - $08
.byte $04,$FF,$FE
PE_9EFE:					; $9EFE - $09
.byte $18,$FF,$06,$FF,$06,$01,$FC
PE_9F05:					; $9F05 - $0A
.byte $01,$FF,$01,$FE,$01,$FE,$01,$FE,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$E4
PE_9F24:					; $9F24 - $0B
.byte $01,$00,$01,$FF,$01,$01,$01,$01,$01,$FF,$F8
PE_9F2F:					; $9F2F - $0C
.byte $01,$07,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$01,$FE,$01,$01,$01,$01,$01,$01,$01,$FF,$01,$FF,$01,$FF,$01,$01,$01,$01,$01,$01,$01,$FF,$01,$FF,$01,$FF,$01,$01,$01,$01,$01,$01,$01,$FF,$01,$FF,$01,$FF,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$FE,$01,$FE,$01,$FE,$00
PE_9F7A:					; $9F7A - $0D
.byte $01,$01,$01,$02,$01,$02,$01,$02,$02,$02,$01,$FE,$01,$FE,$01,$FE,$01,$FF,$EE
PE_9F8D:					; $9F8D - $0E
.byte 01,$07,$01,$FD,$01,$FD,$01,$FD,$01,$FD,$02,$FE,$02,$01,$02,$01,$02,$FF,$02,$FF,$F8
PE_9FA2:					; $9FA2 - $0F
.byte $01,$F9,$01,$07,$02,$07,$01,$FE,$01,$FD,$01,$FD,$01,$FD,$01,$FD,$01,$02,$01,$02,$01,$02,$01,$FE,$01,$FE,$01,$FE,$01,$02,$01,$02,$01,$02,$01,$FE,$01,$FE,$01,$FE,$01,$02,$01,$02,$01,$02,$01,$FE,$01,$FE,$01,$FE,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$01,$02,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
PE_NEW1:					; $10
;.byte $0F,$00,$04,$FF,$04,$01,$FC
.byte $0F,$00,$01,$FF,$03,$00,$01,$01,$03,$00,$F8		; OK
PE_NEW2:					; $11
...
PE_NEW4:					; $13 - test GOOD for The Magic House
;.byte $07,$00,$01,$01,$00
;.byte $04,$FF,$04,$01,$FC
;.byte $F0,$49,$41,$49,$32,$3A,$02
