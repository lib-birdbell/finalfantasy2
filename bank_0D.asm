...
; Marks	: Sound ??
	...
	STA $C2			; 9806 $85 $C2
	LDA $E5			; 9808 $A5 $E5
	BEQ L3981A		; 980A $F0 $0E
	DEC $E5			; 980C $C6 $E5
	BNE L3981A		; 980E $D0 $0A
	LDA #$30		; 9810 $A9 $30
...
L3981A:
	LDA $E0			; 981A $A5 $E0
	ASL A			; 981C $0A
.byte $90,$13	;BCC $9832		; 981D $90 $13
	JSR $98A9		; 981F $20 $A9 $98

.byte $A9,$00,$85,$E0,$8D,$1B,$6F,$8D,$1F,$6F,$8D,$23,$6F,$4C
.byte $63,$98

	ASL A			; 9832 $0A
.byte $90,$2E	;BCC $9863		; 9833 $90 $2E
	LDA $E0			; 9835 $A5 $E0
	AND #$3F		; 9837 $29 $3F
	STA $E0			; 9839 $85 $E0
	CMP current_BGM_ID	; 983B $CD $25 $6F
.byte $F0,$07	;BEQ $9847		; 983E $F0 $07
	JSR $988E		; 9840 $20 $8E $98

.byte $20,$67,$98,$60,$C9,$09,$F0,$F8,$A9,$30,$8D,$00,$40
...
.byte $A5,$E0,$8D,$25,$6F,$0A,$AA,$BD,$0D
