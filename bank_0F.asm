...
; Marks	: Set buffer ??
;; sub start ;;
	; Set RAM $03CD,$03CE,$03CF - $00,$02,$30
...
L3E568:
    ...
    STX $81                  ; E56A  $86 $81
    LDX #$02                 ; E56C  $A2 $02
    JSR Set_PpuData_X_100h	; JSR L3E50E               ; E56E  $20 $0E $E5
    LDX #$40                 ; E571  $A2 $40
    ...
    STA $81                  ; E5C2  $85 $81
    LDX #$03                 ; E5C4  $A2 $03
    JSR Set_PpuData_X_100h	; JSR L3E50E               ; E5C6  $20 $0E $E5
    LDX #$C0                 ; E5C9  $A2 $C0
    JSR Set_PpuData_XY		; JSR L3E51E               ; E5CB  $20 $1E $E5

; Name	:
; Marks	: Set $80-$81 to $8A00
;	  Copy to PPU CHR $06E0
;; sub start ;;
    LDA #$09                 ; E5CE  $A9 $09
    ...
    LDY #$00                 ; E5E8  $A0 $00
    LDX #$20                 ; E5EA  $A2 $20
	; PRG $24A00 -> PPU $06E0 (#$20)
    JSR Set_PpuData_XY		; JSR L3E51E               ; E5EC  $20 $1E $E5
    LDA #$20                 ; E5EF  $A9 $20
    STA $80                  ; E5F1  $85 $80
	; $80(ADDR) to PPU (ROM 0x24A20 : $8A20-$9320 to PPU $06F0-$0FF0)
    LDX #$09                 ; E5F3  $A2 $09
    JMP Set_PpuData_X_100h	; JMP L3E50E               ; E5F5  $4C $0E $E5
; End of
...
; Name	: Load_char_tile
; Marks	: Character tile CHR compressed address(from $E76A-$E775)
;; sub start ;;
Load_char_tile:
    AND #$0F                 ; E745  $29 $0F
    TAX                      ; E747  $AA
...
; Name	:
; Marks	: Copy $83B2,X:003B2 to $03D0,X
;; sub start ;;
    LDA #$00                 ; E786  $A9 $00
...
L3EC6C:
    JSR Set_daddr_99h		; JSR $EDF9                ; EC6C  $20 $F9 $ED
    LDA #$0A                 ; EC6F  $A9 $0A
...
L3ED29:
    ASL A                    ; ED29  $0A
    TAX                      ; ED2A  $AA
    JSR Set_daddr_99h		; JSR $EDF9                ; ED2B  $20 $F9 $ED
    LDA #$0A                 ; ED2E  $A9 $0A
...
L3ED53:
    ...
    STA $5F                  ; ED75  $85 $5F
L3ED77:
    JSR Set_daddr_99h		; JSR $EDF9                ; ED77  $20 $F9 $ED
    LDA #$5A                 ; ED7A  $A9 $5A
    STA $3E                  ; ED7C  $85 $3E
    LDA #$00                 ; ED7E  $A9 $00
    STA $3F                  ; ED80  $85 $3F
...
L3EDAF:
    ADC $67                  ; EDAF  $65 $67
    TAX                      ; EDB1  $AA
    JSR Set_daddr_99h		; JSR $EDF9                ; EDB2  $20 $F9 $ED
    LDA #$0A                 ; EDB5  $A9 $0A
