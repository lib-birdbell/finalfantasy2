...
L3D531:
	...
	STA scroll_dir_map	; D53F  $85 $2D		make vertical direction
...
;; sub start ;;
	...
	BNE L3D621		; D5DC  $D0 $43		if horizontal direction
	; vertical scrolling
L3D5DE:
...
L3D694:
	...
	AND #$02		; D696  $29 $02
	BEQ L3D69D		; D698  $F0 $03		if vertical direction
...
;; sub start ;;
	JSR Init_sprites	; D990  $20 $7D $D9
	LDA #$01		; D993  $A9 $01
...
L3DBD7:
	...
	TAX			; DBE3  $AA
	AND #$10		; DBE4  $29 $10
	BEQ L3DBF6		; DBE6  $F0 $0E		if start not pressing ??
...
L3DBF6:
	TXA			; DBF6  $8A
	AND #$20		; DBF7  $29 $20		if select not pressing ??
...
L3DC09:
	TXA			; DC09  $8A
	AND #$40		; DC0A  $29 $40		if B not pressing ??
...
L3DC1C:
	TXA			; DC1C  $8A
	AND #$80		; DC1D  $29 $80
	BEQ L3DC2F		; DC1F  $F0 $0E		if A not pressing
...
L3DDA4:
	STA $8C			; DDA4  $85 $8C
	JSR L3DC5E		; DDA6  $20 $5E $DC	sprite reflesh ??
...
Copy_attr:
	...
	LDA $8C			; DE10  $A5 $8C
	LSR A			; DE12  $4A
	BCC Copy_bg_palettes	; DE13  $90 $10
	JSR Copy_bg_palettes	; DE15  $20 $25 $DE
	DEX			; DE18  $CA
L3DE19:
	LDA $03F0,X		; DE19  $BD $F0 $03	attribute table ?? check ??
	AND #$0F		; DE1C  $29 $0F
...
L3DE3A:
	LDA $03F0,X		; DE3A  $BD $F0 $03	attribute table ??
	CMP #$0F		; DE3D  $C9 $0F
...
L3DEB0:
	JSR $E238		; DEB0  $20 $38 $E2	dreadnaught ??
...
L3E046:
	...
	LSR A			; E048  $4A
	BCC L3E04C		; E049  $90 $01		if world map
	RTS			; E04B  $60
; End of
...
L3E0E1:
	...
	AND #$01		; E0E3  $29 $01
	LSR A			; E0E5  $4A
	BCS L3E0F3		; E0E6  $B0 $0B		if normal map
...
;; sub start ;;
	...
	JSR Ship_visible	; E186  $20 $08 $E2
...
E194:
	...
	JSR Ship_visible	; E19A  $20 $08 $E2
...
;; sub start ;;
	...
	JSR Ship_visible	; E1B9  $20 $08 $E2
...
;; sub start ;;
	...
	JSR Ship_visible	; E1ED  $20 $08 $E2
...
E3E0:
    ...
    LDA #$00                 ; E476  $A9 $00
    JSR Set_PpuAddrData_XPage	; JSR L3E503               ; E478  $20 $03 $E5
    LDA #$80                 ; E47B  $A9 $80
    STA $81                  ; E47D  $85 $81
    LDX #$0A                 ; E47F  $A2 $0A
    LDA #$10                 ; E481  $A9 $10
...
L3E88A:
	...
	ADC #$04                 ; E88C  $69 $04
	TAY                      ; E88E  $A8
	BCC L3E85D               ; E88F  $90 $CC	if A not exceed FFh
	RTS                      ; E891  $60
; End of
...
; X	:
L3FA9E:
	STA $7B48		; FA9E  $8D $48 $7B	Set some battle status ??
    TXA                      ; FAA1  $8A
    AND #$0F                 ; FAA2  $29 $0F
